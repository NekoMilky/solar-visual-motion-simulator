...
}`;function NS(n,t,e){let i=new Ud;const s=new Ht,r=new Ht,o=new Ee,a=new ev({depthPacking:Jg}),l=new nv,c={},u=e.maxTextureSize,h={[ci]:Be,[Be]:ci,[pn]:pn},d=new Ri({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ht},radius:{value:4}},vertexShader:LS,fragmentShader:US}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ve;_.setAttribute("position",new Pn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ve(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ud;let f=this.type;this.render=function(P,C,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||P.length===0)return;const A=n.getRenderTarget(),S=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),F=n.state;F.setBlending(Ai),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const O=f!==Zn&&this.type===Zn,Y=f===Zn&&this.type!==Zn;for(let tt=0,G=P.length;tt<G;tt++){const Z=P[tt],V=Z.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const ct=V.getFrameExtents();if(s.multiply(ct),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ct.x),s.x=r.x*ct.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ct.y),s.y=r.y*ct.y,V.mapSize.y=r.y)),V.map===null||O===!0||Y===!0){const lt=this.type!==Zn?{minFilter:Cn,magFilter:Cn}:{};V.map!==null&&V.map.dispose(),V.map=new Ki(s.x,s.y,lt),V.map.texture.name=Z.name+".shadowMap",V.camera.updateProjectionMatrix()}n.setRenderTarget(V.map),n.clear();const it=V.getViewportCount();for(let lt=0;lt<it;lt++){const ht=V.getViewport(lt);o.set(r.x*ht.x,r.y*ht.y,r.x*ht.z,r.y*ht.w),F.viewport(o),V.updateMatrices(Z,lt),i=V.getFrustum(),x(C,L,V.camera,Z,this.type)}V.isPointLightShadow!==!0&&this.type===Zn&&w(V,L),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(A,S,I)};function w(P,C){const L=t.update(v);d.defines.VSM_SAMPLES!==P.blurSamples&&(d.defines.VSM_SAMPLES=P.blurSamples,p.defines.VSM_SAMPLES=P.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Ki(s.x,s.y)),d.uniforms.shadow_pass.value=P.map.texture,d.uniforms.resolution.value=P.mapSize,d.uniforms.radius.value=P.radius,n.setRenderTarget(P.mapPass),n.clear(),n.renderBufferDirect(C,null,L,d,v,null),p.uniforms.shadow_pass.value=P.mapPass.texture,p.uniforms.resolution.value=P.mapSize,p.uniforms.radius.value=P.radius,n.setRenderTarget(P.map),n.clear(),n.renderBufferDirect(C,null,L,p,v,null)}function b(P,C,L,A){let S=null;const I=L.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(I!==void 0)S=I;else if(S=L.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const F=S.uuid,O=C.uuid;let Y=c[F];Y===void 0&&(Y={},c[F]=Y);let tt=Y[O];tt===void 0&&(tt=S.clone(),Y[O]=tt,C.addEventListener("dispose",T)),S=tt}if(S.visible=C.visible,S.wireframe=C.wireframe,A===Zn?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:h[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const F=n.properties.get(S);F.light=L}return S}function x(P,C,L,A,S){if(P.visible===!1)return;if(P.layers.test(C.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&S===Zn)&&(!P.frustumCulled||i.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,P.matrixWorld);const O=t.update(P),Y=P.material;if(Array.isArray(Y)){const tt=O.groups;for(let G=0,Z=tt.length;G<Z;G++){const V=tt[G],ct=Y[V.materialIndex];if(ct&&ct.visible){const it=b(P,ct,A,S);P.onBeforeShadow(n,P,C,L,O,it,V),n.renderBufferDirect(L,null,O,it,P,V),P.onAfterShadow(n,P,C,L,O,it,V)}}}else if(Y.visible){const tt=b(P,Y,A,S);P.onBeforeShadow(n,P,C,L,O,tt,null),n.renderBufferDirect(L,null,O,tt,P,null),P.onAfterShadow(n,P,C,L,O,tt,null)}}const F=P.children;for(let O=0,Y=F.length;O<Y;O++)x(F[O],C,L,A,S)}function T(P){P.target.removeEventListener("dispose",T);for(const L in c){const A=c[L],S=P.target.uuid;S in A&&(A[S].dispose(),delete A[S])}}}const FS={[Sl]:yl,[El]:bl,[Al]:wl,[Os]:Tl,[yl]:Sl,[bl]:El,[wl]:Al,[Tl]:Os};function OS(n,t){function e(){let N=!1;const yt=new Ee;let dt=null;const Pt=new Ee(0,0,0,0);return{setMask:function(pt){dt!==pt&&!N&&(n.colorMask(pt,pt,pt,pt),dt=pt)},setLocked:function(pt){N=pt},setClear:function(pt,at,Lt,qt,pe){pe===!0&&(pt*=qt,at*=qt,Lt*=qt),yt.set(pt,at,Lt,qt),Pt.equals(yt)===!1&&(n.clearColor(pt,at,Lt,qt),Pt.copy(yt))},reset:function(){N=!1,dt=null,Pt.set(-1,0,0,0)}}}function i(){let N=!1,yt=!1,dt=null,Pt=null,pt=null;return{setReversed:function(at){if(yt!==at){const Lt=t.get("EXT_clip_control");at?Lt.clipControlEXT(Lt.LOWER_LEFT_EXT,Lt.ZERO_TO_ONE_EXT):Lt.clipControlEXT(Lt.LOWER_LEFT_EXT,Lt.NEGATIVE_ONE_TO_ONE_EXT),yt=at;const qt=pt;pt=null,this.setClear(qt)}},getReversed:function(){return yt},setTest:function(at){at?mt(n.DEPTH_TEST):ft(n.DEPTH_TEST)},setMask:function(at){dt!==at&&!N&&(n.depthMask(at),dt=at)},setFunc:function(at){if(yt&&(at=FS[at]),Pt!==at){switch(at){case Sl:n.depthFunc(n.NEVER);break;case yl:n.depthFunc(n.ALWAYS);break;case El:n.depthFunc(n.LESS);break;case Os:n.depthFunc(n.LEQUAL);break;case Al:n.depthFunc(n.EQUAL);break;case Tl:n.depthFunc(n.GEQUAL);break;case bl:n.depthFunc(n.GREATER);break;case wl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Pt=at}},setLocked:function(at){N=at},setClear:function(at){pt!==at&&(yt&&(at=1-at),n.clearDepth(at),pt=at)},reset:function(){N=!1,dt=null,Pt=null,pt=null,yt=!1}}}function s(){let N=!1,yt=null,dt=null,Pt=null,pt=null,at=null,Lt=null,qt=null,pe=null;return{setTest:function(ae){N||(ae?mt(n.STENCIL_TEST):ft(n.STENCIL_TEST))},setMask:function(ae){yt!==ae&&!N&&(n.stencilMask(ae),yt=ae)},setFunc:function(ae,vn,Gn){(dt!==ae||Pt!==vn||pt!==Gn)&&(n.stencilFunc(ae,vn,Gn),dt=ae,Pt=vn,pt=Gn)},setOp:function(ae,vn,Gn){(at!==ae||Lt!==vn||qt!==Gn)&&(n.stencilOp(ae,vn,Gn),at=ae,Lt=vn,qt=Gn)},setLocked:function(ae){N=ae},setClear:function(ae){pe!==ae&&(n.clearStencil(ae),pe=ae)},reset:function(){N=!1,yt=null,dt=null,Pt=null,pt=null,at=null,Lt=null,qt=null,pe=null}}}const r=new e,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},h={},d=new WeakMap,p=[],_=null,v=!1,m=null,f=null,w=null,b=null,x=null,T=null,P=null,C=new Yt(0,0,0),L=0,A=!1,S=null,I=null,F=null,O=null,Y=null;const tt=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,Z=0;const V=n.getParameter(n.VERSION);V.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(V)[1]),G=Z>=1):V.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),G=Z>=2);let ct=null,it={};const lt=n.getParameter(n.SCISSOR_BOX),ht=n.getParameter(n.VIEWPORT),Nt=new Ee().fromArray(lt),W=new Ee().fromArray(ht);function st(N,yt,dt,Pt){const pt=new Uint8Array(4),at=n.createTexture();n.bindTexture(N,at),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Lt=0;Lt<dt;Lt++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(yt,0,n.RGBA,1,1,Pt,0,n.RGBA,n.UNSIGNED_BYTE,pt):n.texImage2D(yt+Lt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pt);return at}const xt={};xt[n.TEXTURE_2D]=st(n.TEXTURE_2D,n.TEXTURE_2D,1),xt[n.TEXTURE_CUBE_MAP]=st(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),xt[n.TEXTURE_2D_ARRAY]=st(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),xt[n.TEXTURE_3D]=st(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),mt(n.DEPTH_TEST),o.setFunc(Os),J(!1),nt(Fu),mt(n.CULL_FACE),M(Ai);function mt(N){u[N]!==!0&&(n.enable(N),u[N]=!0)}function ft(N){u[N]!==!1&&(n.disable(N),u[N]=!1)}function zt(N,yt){return h[N]!==yt?(n.bindFramebuffer(N,yt),h[N]=yt,N===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=yt),N===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=yt),!0):!1}function bt(N,yt){let dt=p,Pt=!1;if(N){dt=d.get(yt),dt===void 0&&(dt=[],d.set(yt,dt));const pt=N.textures;if(dt.length!==pt.length||dt[0]!==n.COLOR_ATTACHMENT0){for(let at=0,Lt=pt.length;at<Lt;at++)dt[at]=n.COLOR_ATTACHMENT0+at;dt.length=pt.length,Pt=!0}}else dt[0]!==n.BACK&&(dt[0]=n.BACK,Pt=!0);Pt&&n.drawBuffers(dt)}function Jt(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const R={[Gi]:n.FUNC_ADD,[Ag]:n.FUNC_SUBTRACT,[Tg]:n.FUNC_REVERSE_SUBTRACT};R[bg]=n.MIN,R[wg]=n.MAX;const D={[Rg]:n.ZERO,[Cg]:n.ONE,[Pg]:n.SRC_COLOR,[xl]:n.SRC_ALPHA,[Fg]:n.SRC_ALPHA_SATURATE,[Ug]:n.DST_COLOR,[Ig]:n.DST_ALPHA,[Dg]:n.ONE_MINUS_SRC_COLOR,[Ml]:n.ONE_MINUS_SRC_ALPHA,[Ng]:n.ONE_MINUS_DST_COLOR,[Lg]:n.ONE_MINUS_DST_ALPHA,[Og]:n.CONSTANT_COLOR,[Bg]:n.ONE_MINUS_CONSTANT_COLOR,[zg]:n.CONSTANT_ALPHA,[Hg]:n.ONE_MINUS_CONSTANT_ALPHA};function M(N,yt,dt,Pt,pt,at,Lt,qt,pe,ae){if(N===Ai){v===!0&&(ft(n.BLEND),v=!1);return}if(v===!1&&(mt(n.BLEND),v=!0),N!==Eg){if(N!==m||ae!==A){if((f!==Gi||x!==Gi)&&(n.blendEquation(n.FUNC_ADD),f=Gi,x=Gi),ae)switch(N){case Ls:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ou:n.blendFunc(n.ONE,n.ONE);break;case Bu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case zu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Ls:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ou:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Bu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case zu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}w=null,b=null,T=null,P=null,C.set(0,0,0),L=0,m=N,A=ae}return}pt=pt||yt,at=at||dt,Lt=Lt||Pt,(yt!==f||pt!==x)&&(n.blendEquationSeparate(R[yt],R[pt]),f=yt,x=pt),(dt!==w||Pt!==b||at!==T||Lt!==P)&&(n.blendFuncSeparate(D[dt],D[Pt],D[at],D[Lt]),w=dt,b=Pt,T=at,P=Lt),(qt.equals(C)===!1||pe!==L)&&(n.blendColor(qt.r,qt.g,qt.b,pe),C.copy(qt),L=pe),m=N,A=!1}function ot(N,yt){N.side===pn?ft(n.CULL_FACE):mt(n.CULL_FACE);let dt=N.side===Be;yt&&(dt=!dt),J(dt),N.blending===Ls&&N.transparent===!1?M(Ai):M(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const Pt=N.stencilWrite;a.setTest(Pt),Pt&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),rt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?mt(n.SAMPLE_ALPHA_TO_COVERAGE):ft(n.SAMPLE_ALPHA_TO_COVERAGE)}function J(N){S!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),S=N)}function nt(N){N!==Mg?(mt(n.CULL_FACE),N!==I&&(N===Fu?n.cullFace(n.BACK):N===Sg?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ft(n.CULL_FACE),I=N}function Q(N){N!==F&&(G&&n.lineWidth(N),F=N)}function rt(N,yt,dt){N?(mt(n.POLYGON_OFFSET_FILL),(O!==yt||Y!==dt)&&(n.polygonOffset(yt,dt),O=yt,Y=dt)):ft(n.POLYGON_OFFSET_FILL)}function K(N){N?mt(n.SCISSOR_TEST):ft(n.SCISSOR_TEST)}function $(N){N===void 0&&(N=n.TEXTURE0+tt-1),ct!==N&&(n.activeTexture(N),ct=N)}function St(N,yt,dt){dt===void 0&&(ct===null?dt=n.TEXTURE0+tt-1:dt=ct);let Pt=it[dt];Pt===void 0&&(Pt={type:void 0,texture:void 0},it[dt]=Pt),(Pt.type!==N||Pt.texture!==yt)&&(ct!==dt&&(n.activeTexture(dt),ct=dt),n.bindTexture(N,yt||xt[N]),Pt.type=N,Pt.texture=yt)}function E(){const N=it[ct];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function g(){try{n.compressedTexImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function U(){try{n.compressedTexImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function X(){try{n.texSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function et(){try{n.texSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function k(){try{n.compressedTexSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function At(){try{n.compressedTexSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function _t(){try{n.texStorage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Tt(){try{n.texStorage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Rt(){try{n.texImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ut(){try{n.texImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function wt(N){Nt.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),Nt.copy(N))}function Dt(N){W.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),W.copy(N))}function It(N,yt){let dt=c.get(yt);dt===void 0&&(dt=new WeakMap,c.set(yt,dt));let Pt=dt.get(N);Pt===void 0&&(Pt=n.getUniformBlockIndex(yt,N.name),dt.set(N,Pt))}function vt(N,yt){const Pt=c.get(yt).get(N);l.get(yt)!==Pt&&(n.uniformBlockBinding(yt,Pt,N.__bindingPointIndex),l.set(yt,Pt))}function Xt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ct=null,it={},h={},d=new WeakMap,p=[],_=null,v=!1,m=null,f=null,w=null,b=null,x=null,T=null,P=null,C=new Yt(0,0,0),L=0,A=!1,S=null,I=null,F=null,O=null,Y=null,Nt.set(0,0,n.canvas.width,n.canvas.height),W.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:mt,disable:ft,bindFramebuffer:zt,drawBuffers:bt,useProgram:Jt,setBlending:M,setMaterial:ot,setFlipSided:J,setCullFace:nt,setLineWidth:Q,setPolygonOffset:rt,setScissorTest:K,activeTexture:$,bindTexture:St,unbindTexture:E,compressedTexImage2D:g,compressedTexImage3D:U,texImage2D:Rt,texImage3D:ut,updateUBOMapping:It,uniformBlockBinding:vt,texStorage2D:_t,texStorage3D:Tt,texSubImage2D:X,texSubImage3D:et,compressedTexSubImage2D:k,compressedTexSubImage3D:At,scissor:wt,viewport:Dt,reset:Xt}}function BS(n,t,e,i,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ht,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,g){return p?new OffscreenCanvas(E,g):br("canvas")}function v(E,g,U){let X=1;const et=St(E);if((et.width>U||et.height>U)&&(X=U/Math.max(et.width,et.height)),X<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const k=Math.floor(X*et.width),At=Math.floor(X*et.height);h===void 0&&(h=_(k,At));const _t=g?_(k,At):h;return _t.width=k,_t.height=At,_t.getContext("2d").drawImage(E,0,0,k,At),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+k+"x"+At+")."),_t}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),E;return E}function m(E){return E.generateMipmaps}function f(E){n.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?n.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(E,g,U,X,et=!1){if(E!==null){if(n[E]!==void 0)return n[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let k=g;if(g===n.RED&&(U===n.FLOAT&&(k=n.R32F),U===n.HALF_FLOAT&&(k=n.R16F),U===n.UNSIGNED_BYTE&&(k=n.R8)),g===n.RED_INTEGER&&(U===n.UNSIGNED_BYTE&&(k=n.R8UI),U===n.UNSIGNED_SHORT&&(k=n.R16UI),U===n.UNSIGNED_INT&&(k=n.R32UI),U===n.BYTE&&(k=n.R8I),U===n.SHORT&&(k=n.R16I),U===n.INT&&(k=n.R32I)),g===n.RG&&(U===n.FLOAT&&(k=n.RG32F),U===n.HALF_FLOAT&&(k=n.RG16F),U===n.UNSIGNED_BYTE&&(k=n.RG8)),g===n.RG_INTEGER&&(U===n.UNSIGNED_BYTE&&(k=n.RG8UI),U===n.UNSIGNED_SHORT&&(k=n.RG16UI),U===n.UNSIGNED_INT&&(k=n.RG32UI),U===n.BYTE&&(k=n.RG8I),U===n.SHORT&&(k=n.RG16I),U===n.INT&&(k=n.RG32I)),g===n.RGB_INTEGER&&(U===n.UNSIGNED_BYTE&&(k=n.RGB8UI),U===n.UNSIGNED_SHORT&&(k=n.RGB16UI),U===n.UNSIGNED_INT&&(k=n.RGB32UI),U===n.BYTE&&(k=n.RGB8I),U===n.SHORT&&(k=n.RGB16I),U===n.INT&&(k=n.RGB32I)),g===n.RGBA_INTEGER&&(U===n.UNSIGNED_BYTE&&(k=n.RGBA8UI),U===n.UNSIGNED_SHORT&&(k=n.RGBA16UI),U===n.UNSIGNED_INT&&(k=n.RGBA32UI),U===n.BYTE&&(k=n.RGBA8I),U===n.SHORT&&(k=n.RGBA16I),U===n.INT&&(k=n.RGBA32I)),g===n.RGB&&U===n.UNSIGNED_INT_5_9_9_9_REV&&(k=n.RGB9_E5),g===n.RGBA){const At=et?Wo:ee.getTransfer(X);U===n.FLOAT&&(k=n.RGBA32F),U===n.HALF_FLOAT&&(k=n.RGBA16F),U===n.UNSIGNED_BYTE&&(k=At===ue?n.SRGB8_ALPHA8:n.RGBA8),U===n.UNSIGNED_SHORT_4_4_4_4&&(k=n.RGBA4),U===n.UNSIGNED_SHORT_5_5_5_1&&(k=n.RGB5_A1)}return(k===n.R16F||k===n.R32F||k===n.RG16F||k===n.RG32F||k===n.RGBA16F||k===n.RGBA32F)&&t.get("EXT_color_buffer_float"),k}function x(E,g){let U;return E?g===null||g===Zi||g===yr?U=n.DEPTH24_STENCIL8:g===ei?U=n.DEPTH32F_STENCIL8:g===Sr&&(U=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Zi||g===yr?U=n.DEPTH_COMPONENT24:g===ei?U=n.DEPTH_COMPONENT32F:g===Sr&&(U=n.DEPTH_COMPONENT16),U}function T(E,g){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==Cn&&E.minFilter!==Fe?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function P(E){const g=E.target;g.removeEventListener("dispose",P),L(g),g.isVideoTexture&&u.delete(g)}function C(E){const g=E.target;g.removeEventListener("dispose",C),S(g)}function L(E){const g=i.get(E);if(g.__webglInit===void 0)return;const U=E.source,X=d.get(U);if(X){const et=X[g.__cacheKey];et.usedTimes--,et.usedTimes===0&&A(E),Object.keys(X).length===0&&d.delete(U)}i.remove(E)}function A(E){const g=i.get(E);n.deleteTexture(g.__webglTexture);const U=E.source,X=d.get(U);delete X[g.__cacheKey],o.memory.textures--}function S(E){const g=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(g.__webglFramebuffer[X]))for(let et=0;et<g.__webglFramebuffer[X].length;et++)n.deleteFramebuffer(g.__webglFramebuffer[X][et]);else n.deleteFramebuffer(g.__webglFramebuffer[X]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[X])}else{if(Array.isArray(g.__webglFramebuffer))for(let X=0;X<g.__webglFramebuffer.length;X++)n.deleteFramebuffer(g.__webglFramebuffer[X]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let X=0;X<g.__webglColorRenderbuffer.length;X++)g.__webglColorRenderbuffer[X]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[X]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const U=E.textures;for(let X=0,et=U.length;X<et;X++){const k=i.get(U[X]);k.__webglTexture&&(n.deleteTexture(k.__webglTexture),o.memory.textures--),i.remove(U[X])}i.remove(E)}let I=0;function F(){I=0}function O(){const E=I;return E>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),I+=1,E}function Y(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function tt(E,g){const U=i.get(E);if(E.isVideoTexture&&K(E),E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){const X=E.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{xt(U,E,g);return}}e.bindTexture(n.TEXTURE_2D,U.__webglTexture,n.TEXTURE0+g)}function G(E,g){const U=i.get(E);if(E.version>0&&U.__version!==E.version){xt(U,E,g);return}e.bindTexture(n.TEXTURE_2D_ARRAY,U.__webglTexture,n.TEXTURE0+g)}function Z(E,g){const U=i.get(E);if(E.version>0&&U.__version!==E.version){xt(U,E,g);return}e.bindTexture(n.TEXTURE_3D,U.__webglTexture,n.TEXTURE0+g)}function V(E,g){const U=i.get(E);if(E.version>0&&U.__version!==E.version){mt(U,E,g);return}e.bindTexture(n.TEXTURE_CUBE_MAP,U.__webglTexture,n.TEXTURE0+g)}const ct={[Pl]:n.REPEAT,[Fn]:n.CLAMP_TO_EDGE,[Dl]:n.MIRRORED_REPEAT},it={[Cn]:n.NEAREST,[$g]:n.NEAREST_MIPMAP_NEAREST,[zr]:n.NEAREST_MIPMAP_LINEAR,[Fe]:n.LINEAR,[Aa]:n.LINEAR_MIPMAP_NEAREST,[Wi]:n.LINEAR_MIPMAP_LINEAR},lt={[t_]:n.NEVER,[o_]:n.ALWAYS,[e_]:n.LESS,[yd]:n.LEQUAL,[n_]:n.EQUAL,[r_]:n.GEQUAL,[i_]:n.GREATER,[s_]:n.NOTEQUAL};function ht(E,g){if(g.type===ei&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Fe||g.magFilter===Aa||g.magFilter===zr||g.magFilter===Wi||g.minFilter===Fe||g.minFilter===Aa||g.minFilter===zr||g.minFilter===Wi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(E,n.TEXTURE_WRAP_S,ct[g.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,ct[g.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,ct[g.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,it[g.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,it[g.minFilter]),g.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,lt[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Cn||g.minFilter!==zr&&g.minFilter!==Wi||g.type===ei&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const U=t.get("EXT_texture_filter_anisotropic");n.texParameterf(E,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function Nt(E,g){let U=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",P));const X=g.source;let et=d.get(X);et===void 0&&(et={},d.set(X,et));const k=Y(g);if(k!==E.__cacheKey){et[k]===void 0&&(et[k]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,U=!0),et[k].usedTimes++;const At=et[E.__cacheKey];At!==void 0&&(et[E.__cacheKey].usedTimes--,At.usedTimes===0&&A(g)),E.__cacheKey=k,E.__webglTexture=et[k].texture}return U}function W(E,g,U){return Math.floor(Math.floor(E/U)/g)}function st(E,g,U,X){const k=E.updateRanges;if(k.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,g.width,g.height,U,X,g.data);else{k.sort((ut,wt)=>ut.start-wt.start);let At=0;for(let ut=1;ut<k.length;ut++){const wt=k[At],Dt=k[ut],It=wt.start+wt.count,vt=W(Dt.start,g.width,4),Xt=W(wt.start,g.width,4);Dt.start<=It+1&&vt===Xt&&W(Dt.start+Dt.count-1,g.width,4)===vt?wt.count=Math.max(wt.count,Dt.start+Dt.count-wt.start):(++At,k[At]=Dt)}k.length=At+1;const _t=n.getParameter(n.UNPACK_ROW_LENGTH),Tt=n.getParameter(n.UNPACK_SKIP_PIXELS),Rt=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,g.width);for(let ut=0,wt=k.length;ut<wt;ut++){const Dt=k[ut],It=Math.floor(Dt.start/4),vt=Math.ceil(Dt.count/4),Xt=It%g.width,N=Math.floor(It/g.width),yt=vt,dt=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xt),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),e.texSubImage2D(n.TEXTURE_2D,0,Xt,N,yt,dt,U,X,g.data)}E.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,_t),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Tt),n.pixelStorei(n.UNPACK_SKIP_ROWS,Rt)}}function xt(E,g,U){let X=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(X=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(X=n.TEXTURE_3D);const et=Nt(E,g),k=g.source;e.bindTexture(X,E.__webglTexture,n.TEXTURE0+U);const At=i.get(k);if(k.version!==At.__version||et===!0){e.activeTexture(n.TEXTURE0+U);const _t=ee.getPrimaries(ee.workingColorSpace),Tt=g.colorSpace===Si?null:ee.getPrimaries(g.colorSpace),Rt=g.colorSpace===Si||_t===Tt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Rt);let ut=v(g.image,!1,s.maxTextureSize);ut=$(g,ut);const wt=r.convert(g.format,g.colorSpace),Dt=r.convert(g.type);let It=b(g.internalFormat,wt,Dt,g.colorSpace,g.isVideoTexture);ht(X,g);let vt;const Xt=g.mipmaps,N=g.isVideoTexture!==!0,yt=At.__version===void 0||et===!0,dt=k.dataReady,Pt=T(g,ut);if(g.isDepthTexture)It=x(g.format===Ar,g.type),yt&&(N?e.texStorage2D(n.TEXTURE_2D,1,It,ut.width,ut.height):e.texImage2D(n.TEXTURE_2D,0,It,ut.width,ut.height,0,wt,Dt,null));else if(g.isDataTexture)if(Xt.length>0){N&&yt&&e.texStorage2D(n.TEXTURE_2D,Pt,It,Xt[0].width,Xt[0].height);for(let pt=0,at=Xt.length;pt<at;pt++)vt=Xt[pt],N?dt&&e.texSubImage2D(n.TEXTURE_2D,pt,0,0,vt.width,vt.height,wt,Dt,vt.data):e.texImage2D(n.TEXTURE_2D,pt,It,vt.width,vt.height,0,wt,Dt,vt.data);g.generateMipmaps=!1}else N?(yt&&e.texStorage2D(n.TEXTURE_2D,Pt,It,ut.width,ut.height),dt&&st(g,ut,wt,Dt)):e.texImage2D(n.TEXTURE_2D,0,It,ut.width,ut.height,0,wt,Dt,ut.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){N&&yt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Pt,It,Xt[0].width,Xt[0].height,ut.depth);for(let pt=0,at=Xt.length;pt<at;pt++)if(vt=Xt[pt],g.format!==bn)if(wt!==null)if(N){if(dt)if(g.layerUpdates.size>0){const Lt=dh(vt.width,vt.height,g.format,g.type);for(const qt of g.layerUpdates){const pe=vt.data.subarray(qt*Lt/vt.data.BYTES_PER_ELEMENT,(qt+1)*Lt/vt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pt,0,0,qt,vt.width,vt.height,1,wt,pe)}g.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pt,0,0,0,vt.width,vt.height,ut.depth,wt,vt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,pt,It,vt.width,vt.height,ut.depth,0,vt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?dt&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,pt,0,0,0,vt.width,vt.height,ut.depth,wt,Dt,vt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,pt,It,vt.width,vt.height,ut.depth,0,wt,Dt,vt.data)}else{N&&yt&&e.texStorage2D(n.TEXTURE_2D,Pt,It,Xt[0].width,Xt[0].height);for(let pt=0,at=Xt.length;pt<at;pt++)vt=Xt[pt],g.format!==bn?wt!==null?N?dt&&e.compressedTexSubImage2D(n.TEXTURE_2D,pt,0,0,vt.width,vt.height,wt,vt.data):e.compressedTexImage2D(n.TEXTURE_2D,pt,It,vt.width,vt.height,0,vt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?dt&&e.texSubImage2D(n.TEXTURE_2D,pt,0,0,vt.width,vt.height,wt,Dt,vt.data):e.texImage2D(n.TEXTURE_2D,pt,It,vt.width,vt.height,0,wt,Dt,vt.data)}else if(g.isDataArrayTexture)if(N){if(yt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Pt,It,ut.width,ut.height,ut.depth),dt)if(g.layerUpdates.size>0){const pt=dh(ut.width,ut.height,g.format,g.type);for(const at of g.layerUpdates){const Lt=ut.data.subarray(at*pt/ut.data.BYTES_PER_ELEMENT,(at+1)*pt/ut.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,at,ut.width,ut.height,1,wt,Dt,Lt)}g.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ut.width,ut.height,ut.depth,wt,Dt,ut.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,It,ut.width,ut.height,ut.depth,0,wt,Dt,ut.data);else if(g.isData3DTexture)N?(yt&&e.texStorage3D(n.TEXTURE_3D,Pt,It,ut.width,ut.height,ut.depth),dt&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ut.width,ut.height,ut.depth,wt,Dt,ut.data)):e.texImage3D(n.TEXTURE_3D,0,It,ut.width,ut.height,ut.depth,0,wt,Dt,ut.data);else if(g.isFramebufferTexture){if(yt)if(N)e.texStorage2D(n.TEXTURE_2D,Pt,It,ut.width,ut.height);else{let pt=ut.width,at=ut.height;for(let Lt=0;Lt<Pt;Lt++)e.texImage2D(n.TEXTURE_2D,Lt,It,pt,at,0,wt,Dt,null),pt>>=1,at>>=1}}else if(Xt.length>0){if(N&&yt){const pt=St(Xt[0]);e.texStorage2D(n.TEXTURE_2D,Pt,It,pt.width,pt.height)}for(let pt=0,at=Xt.length;pt<at;pt++)vt=Xt[pt],N?dt&&e.texSubImage2D(n.TEXTURE_2D,pt,0,0,wt,Dt,vt):e.texImage2D(n.TEXTURE_2D,pt,It,wt,Dt,vt);g.generateMipmaps=!1}else if(N){if(yt){const pt=St(ut);e.texStorage2D(n.TEXTURE_2D,Pt,It,pt.width,pt.height)}dt&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,wt,Dt,ut)}else e.texImage2D(n.TEXTURE_2D,0,It,wt,Dt,ut);m(g)&&f(X),At.__version=k.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function mt(E,g,U){if(g.image.length!==6)return;const X=Nt(E,g),et=g.source;e.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+U);const k=i.get(et);if(et.version!==k.__version||X===!0){e.activeTexture(n.TEXTURE0+U);const At=ee.getPrimaries(ee.workingColorSpace),_t=g.colorSpace===Si?null:ee.getPrimaries(g.colorSpace),Tt=g.colorSpace===Si||At===_t?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Tt);const Rt=g.isCompressedTexture||g.image[0].isCompressedTexture,ut=g.image[0]&&g.image[0].isDataTexture,wt=[];for(let at=0;at<6;at++)!Rt&&!ut?wt[at]=v(g.image[at],!0,s.maxCubemapSize):wt[at]=ut?g.image[at].image:g.image[at],wt[at]=$(g,wt[at]);const Dt=wt[0],It=r.convert(g.format,g.colorSpace),vt=r.convert(g.type),Xt=b(g.internalFormat,It,vt,g.colorSpace),N=g.isVideoTexture!==!0,yt=k.__version===void 0||X===!0,dt=et.dataReady;let Pt=T(g,Dt);ht(n.TEXTURE_CUBE_MAP,g);let pt;if(Rt){N&&yt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,Pt,Xt,Dt.width,Dt.height);for(let at=0;at<6;at++){pt=wt[at].mipmaps;for(let Lt=0;Lt<pt.length;Lt++){const qt=pt[Lt];g.format!==bn?It!==null?N?dt&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt,0,0,qt.width,qt.height,It,qt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt,Xt,qt.width,qt.height,0,qt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?dt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt,0,0,qt.width,qt.height,It,vt,qt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt,Xt,qt.width,qt.height,0,It,vt,qt.data)}}}else{if(pt=g.mipmaps,N&&yt){pt.length>0&&Pt++;const at=St(wt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,Pt,Xt,at.width,at.height)}for(let at=0;at<6;at++)if(ut){N?dt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,0,0,wt[at].width,wt[at].height,It,vt,wt[at].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,Xt,wt[at].width,wt[at].height,0,It,vt,wt[at].data);for(let Lt=0;Lt<pt.length;Lt++){const pe=pt[Lt].image[at].image;N?dt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt+1,0,0,pe.width,pe.height,It,vt,pe.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt+1,Xt,pe.width,pe.height,0,It,vt,pe.data)}}else{N?dt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,0,0,It,vt,wt[at]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,Xt,It,vt,wt[at]);for(let Lt=0;Lt<pt.length;Lt++){const qt=pt[Lt];N?dt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt+1,0,0,It,vt,qt.image[at]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+at,Lt+1,Xt,It,vt,qt.image[at])}}}m(g)&&f(n.TEXTURE_CUBE_MAP),k.__version=et.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function ft(E,g,U,X,et,k){const At=r.convert(U.format,U.colorSpace),_t=r.convert(U.type),Tt=b(U.internalFormat,At,_t,U.colorSpace),Rt=i.get(g),ut=i.get(U);if(ut.__renderTarget=g,!Rt.__hasExternalTextures){const wt=Math.max(1,g.width>>k),Dt=Math.max(1,g.height>>k);et===n.TEXTURE_3D||et===n.TEXTURE_2D_ARRAY?e.texImage3D(et,k,Tt,wt,Dt,g.depth,0,At,_t,null):e.texImage2D(et,k,Tt,wt,Dt,0,At,_t,null)}e.bindFramebuffer(n.FRAMEBUFFER,E),rt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,X,et,ut.__webglTexture,0,Q(g)):(et===n.TEXTURE_2D||et>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,X,et,ut.__webglTexture,k),e.bindFramebuffer(n.FRAMEBUFFER,null)}function zt(E,g,U){if(n.bindRenderbuffer(n.RENDERBUFFER,E),g.depthBuffer){const X=g.depthTexture,et=X&&X.isDepthTexture?X.type:null,k=x(g.stencilBuffer,et),At=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,_t=Q(g);rt(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,_t,k,g.width,g.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,_t,k,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,k,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,At,n.RENDERBUFFER,E)}else{const X=g.textures;for(let et=0;et<X.length;et++){const k=X[et],At=r.convert(k.format,k.colorSpace),_t=r.convert(k.type),Tt=b(k.internalFormat,At,_t,k.colorSpace),Rt=Q(g);U&&rt(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Rt,Tt,g.width,g.height):rt(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Rt,Tt,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,Tt,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function bt(E,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=i.get(g.depthTexture);X.__renderTarget=g,(!X.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),tt(g.depthTexture,0);const et=X.__webglTexture,k=Q(g);if(g.depthTexture.format===Er)rt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,et,0,k):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,et,0);else if(g.depthTexture.format===Ar)rt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,et,0,k):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function Jt(E){const g=i.get(E),U=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const X=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),X){const et=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,X.removeEventListener("dispose",et)};X.addEventListener("dispose",et),g.__depthDisposeCallback=et}g.__boundDepthTexture=X}if(E.depthTexture&&!g.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");const X=E.texture.mipmaps;X&&X.length>0?bt(g.__webglFramebuffer[0],E):bt(g.__webglFramebuffer,E)}else if(U){g.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[X]),g.__webglDepthbuffer[X]===void 0)g.__webglDepthbuffer[X]=n.createRenderbuffer(),zt(g.__webglDepthbuffer[X],E,!1);else{const et=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer[X];n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,et,n.RENDERBUFFER,k)}}else{const X=E.texture.mipmaps;if(X&&X.length>0?e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),zt(g.__webglDepthbuffer,E,!1);else{const et=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,et,n.RENDERBUFFER,k)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function R(E,g,U){const X=i.get(E);g!==void 0&&ft(X.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),U!==void 0&&Jt(E)}function D(E){const g=E.texture,U=i.get(E),X=i.get(g);E.addEventListener("dispose",C);const et=E.textures,k=E.isWebGLCubeRenderTarget===!0,At=et.length>1;if(At||(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=g.version,o.memory.textures++),k){U.__webglFramebuffer=[];for(let _t=0;_t<6;_t++)if(g.mipmaps&&g.mipmaps.length>0){U.__webglFramebuffer[_t]=[];for(let Tt=0;Tt<g.mipmaps.length;Tt++)U.__webglFramebuffer[_t][Tt]=n.createFramebuffer()}else U.__webglFramebuffer[_t]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){U.__webglFramebuffer=[];for(let _t=0;_t<g.mipmaps.length;_t++)U.__webglFramebuffer[_t]=n.createFramebuffer()}else U.__webglFramebuffer=n.createFramebuffer();if(At)for(let _t=0,Tt=et.length;_t<Tt;_t++){const Rt=i.get(et[_t]);Rt.__webglTexture===void 0&&(Rt.__webglTexture=n.createTexture(),o.memory.textures++)}if(E.samples>0&&rt(E)===!1){U.__webglMultisampledFramebuffer=n.createFramebuffer(),U.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let _t=0;_t<et.length;_t++){const Tt=et[_t];U.__webglColorRenderbuffer[_t]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,U.__webglColorRenderbuffer[_t]);const Rt=r.convert(Tt.format,Tt.colorSpace),ut=r.convert(Tt.type),wt=b(Tt.internalFormat,Rt,ut,Tt.colorSpace,E.isXRRenderTarget===!0),Dt=Q(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Dt,wt,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+_t,n.RENDERBUFFER,U.__webglColorRenderbuffer[_t])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(U.__webglDepthRenderbuffer=n.createRenderbuffer(),zt(U.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(k){e.bindTexture(n.TEXTURE_CUBE_MAP,X.__webglTexture),ht(n.TEXTURE_CUBE_MAP,g);for(let _t=0;_t<6;_t++)if(g.mipmaps&&g.mipmaps.length>0)for(let Tt=0;Tt<g.mipmaps.length;Tt++)ft(U.__webglFramebuffer[_t][Tt],E,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Tt);else ft(U.__webglFramebuffer[_t],E,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0);m(g)&&f(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(At){for(let _t=0,Tt=et.length;_t<Tt;_t++){const Rt=et[_t],ut=i.get(Rt);e.bindTexture(n.TEXTURE_2D,ut.__webglTexture),ht(n.TEXTURE_2D,Rt),ft(U.__webglFramebuffer,E,Rt,n.COLOR_ATTACHMENT0+_t,n.TEXTURE_2D,0),m(Rt)&&f(n.TEXTURE_2D)}e.unbindTexture()}else{let _t=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(_t=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(_t,X.__webglTexture),ht(_t,g),g.mipmaps&&g.mipmaps.length>0)for(let Tt=0;Tt<g.mipmaps.length;Tt++)ft(U.__webglFramebuffer[Tt],E,g,n.COLOR_ATTACHMENT0,_t,Tt);else ft(U.__webglFramebuffer,E,g,n.COLOR_ATTACHMENT0,_t,0);m(g)&&f(_t),e.unbindTexture()}E.depthBuffer&&Jt(E)}function M(E){const g=E.textures;for(let U=0,X=g.length;U<X;U++){const et=g[U];if(m(et)){const k=w(E),At=i.get(et).__webglTexture;e.bindTexture(k,At),f(k),e.unbindTexture()}}}const ot=[],J=[];function nt(E){if(E.samples>0){if(rt(E)===!1){const g=E.textures,U=E.width,X=E.height;let et=n.COLOR_BUFFER_BIT;const k=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,At=i.get(E),_t=g.length>1;if(_t)for(let Rt=0;Rt<g.length;Rt++)e.bindFramebuffer(n.FRAMEBUFFER,At.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,At.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,At.__webglMultisampledFramebuffer);const Tt=E.texture.mipmaps;Tt&&Tt.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,At.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,At.__webglFramebuffer);for(let Rt=0;Rt<g.length;Rt++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(et|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(et|=n.STENCIL_BUFFER_BIT)),_t){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,At.__webglColorRenderbuffer[Rt]);const ut=i.get(g[Rt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ut,0)}n.blitFramebuffer(0,0,U,X,0,0,U,X,et,n.NEAREST),l===!0&&(ot.length=0,J.length=0,ot.push(n.COLOR_ATTACHMENT0+Rt),E.depthBuffer&&E.resolveDepthBuffer===!1&&(ot.push(k),J.push(k),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,J)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ot))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),_t)for(let Rt=0;Rt<g.length;Rt++){e.bindFramebuffer(n.FRAMEBUFFER,At.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.RENDERBUFFER,At.__webglColorRenderbuffer[Rt]);const ut=i.get(g[Rt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,At.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.TEXTURE_2D,ut,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,At.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const g=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function Q(E){return Math.min(s.maxSamples,E.samples)}function rt(E){const g=i.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function K(E){const g=o.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function $(E,g){const U=E.colorSpace,X=E.format,et=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||U!==Hs&&U!==Si&&(ee.getTransfer(U)===ue?(X!==bn||et!==ui)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),g}function St(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=F,this.setTexture2D=tt,this.setTexture2DArray=G,this.setTexture3D=Z,this.setTextureCube=V,this.rebindTextures=R,this.setupRenderTarget=D,this.updateRenderTargetMipmap=M,this.updateMultisampleRenderTarget=nt,this.setupDepthRenderbuffer=Jt,this.setupFrameBufferTexture=ft,this.useMultisampledRTT=rt}function zS(n,t){function e(i,s=Si){let r;const o=ee.getTransfer(s);if(i===ui)return n.UNSIGNED_BYTE;if(i===Dc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Ic)return n.UNSIGNED_SHORT_5_5_5_1;if(i===md)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dd)return n.BYTE;if(i===pd)return n.SHORT;if(i===Sr)return n.UNSIGNED_SHORT;if(i===Pc)return n.INT;if(i===Zi)return n.UNSIGNED_INT;if(i===ei)return n.FLOAT;if(i===Dr)return n.HALF_FLOAT;if(i===gd)return n.ALPHA;if(i===_d)return n.RGB;if(i===bn)return n.RGBA;if(i===Er)return n.DEPTH_COMPONENT;if(i===Ar)return n.DEPTH_STENCIL;if(i===vd)return n.RED;if(i===Lc)return n.RED_INTEGER;if(i===xd)return n.RG;if(i===Uc)return n.RG_INTEGER;if(i===Nc)return n.RGBA_INTEGER;if(i===So||i===yo||i===Eo||i===Ao)if(o===ue)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===So)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===yo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Eo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ao)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===So)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===yo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Eo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ao)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Il||i===Ll||i===Ul||i===Nl)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Il)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ll)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ul)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Nl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Fl||i===Ol||i===Bl)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Fl||i===Ol)return o===ue?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Bl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===zl||i===Hl||i===Vl||i===Gl||i===kl||i===Wl||i===Xl||i===Yl||i===ql||i===jl||i===Zl||i===$l||i===Kl||i===Jl)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===zl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Hl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Vl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Gl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===kl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Wl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Xl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Yl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ql)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===jl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Zl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$l)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Kl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Jl)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===To||i===Ql||i===tc)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===To)return o===ue?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ql)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===tc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Md||i===ec||i===nc||i===ic)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===To)return r.COMPRESSED_RED_RGTC1_EXT;if(i===ec)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===nc)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ic)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const HS=`
void main() {
...
}`;class GS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const s=new ze,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new Ri({vertexShader:HS,fragmentShader:VS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ve(new ca(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class kS extends ts{constructor(t,e){super();const i=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,d=null,p=null,_=null;const v=new GS,m=e.getContextAttributes();let f=null,w=null;const b=[],x=[],T=new Ht;let P=null;const C=new en;C.viewport=new Ee;const L=new en;L.viewport=new Ee;const A=[C,L],S=new cv;let I=null,F=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let st=b[W];return st===void 0&&(st=new Xa,b[W]=st),st.getTargetRaySpace()},this.getControllerGrip=function(W){let st=b[W];return st===void 0&&(st=new Xa,b[W]=st),st.getGripSpace()},this.getHand=function(W){let st=b[W];return st===void 0&&(st=new Xa,b[W]=st),st.getHandSpace()};function O(W){const st=x.indexOf(W.inputSource);if(st===-1)return;const xt=b[st];xt!==void 0&&(xt.update(W.inputSource,W.frame,c||o),xt.dispatchEvent({type:W.type,data:W.inputSource}))}function Y(){s.removeEventListener("select",O),s.removeEventListener("selectstart",O),s.removeEventListener("selectend",O),s.removeEventListener("squeeze",O),s.removeEventListener("squeezestart",O),s.removeEventListener("squeezeend",O),s.removeEventListener("end",Y),s.removeEventListener("inputsourceschange",tt);for(let W=0;W<b.length;W++){const st=x[W];st!==null&&(x[W]=null,b[W].disconnect(st))}I=null,F=null,v.reset(),t.setRenderTarget(f),p=null,d=null,h=null,s=null,w=null,Nt.stop(),i.isPresenting=!1,t.setPixelRatio(P),t.setSize(T.width,T.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){r=W,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){a=W,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(W){c=W},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(W){if(s=W,s!==null){if(f=t.getRenderTarget(),s.addEventListener("select",O),s.addEventListener("selectstart",O),s.addEventListener("selectend",O),s.addEventListener("squeeze",O),s.addEventListener("squeezestart",O),s.addEventListener("squeezeend",O),s.addEventListener("end",Y),s.addEventListener("inputsourceschange",tt),m.xrCompatible!==!0&&await e.makeXRCompatible(),P=t.getPixelRatio(),t.getSize(T),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let xt=null,mt=null,ft=null;m.depth&&(ft=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,xt=m.stencil?Ar:Er,mt=m.stencil?yr:Zi);const zt={colorFormat:e.RGBA8,depthFormat:ft,scaleFactor:r};h=new XRWebGLBinding(s,e),d=h.createProjectionLayer(zt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),w=new Ki(d.textureWidth,d.textureHeight,{format:bn,type:ui,depthTexture:new Nd(d.textureWidth,d.textureHeight,mt,void 0,void 0,void 0,void 0,void 0,void 0,xt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const xt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,xt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),w=new Ki(p.framebufferWidth,p.framebufferHeight,{format:bn,type:ui,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),Nt.setContext(s),Nt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function tt(W){for(let st=0;st<W.removed.length;st++){const xt=W.removed[st],mt=x.indexOf(xt);mt>=0&&(x[mt]=null,b[mt].disconnect(xt))}for(let st=0;st<W.added.length;st++){const xt=W.added[st];let mt=x.indexOf(xt);if(mt===-1){for(let zt=0;zt<b.length;zt++)if(zt>=x.length){x.push(xt),mt=zt;break}else if(x[zt]===null){x[zt]=xt,mt=zt;break}if(mt===-1)break}const ft=b[mt];ft&&ft.connect(xt)}}const G=new H,Z=new H;function V(W,st,xt){G.setFromMatrixPosition(st.matrixWorld),Z.setFromMatrixPosition(xt.matrixWorld);const mt=G.distanceTo(Z),ft=st.projectionMatrix.elements,zt=xt.projectionMatrix.elements,bt=ft[14]/(ft[10]-1),Jt=ft[14]/(ft[10]+1),R=(ft[9]+1)/ft[5],D=(ft[9]-1)/ft[5],M=(ft[8]-1)/ft[0],ot=(zt[8]+1)/zt[0],J=bt*M,nt=bt*ot,Q=mt/(-M+ot),rt=Q*-M;if(st.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX(rt),W.translateZ(Q),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),ft[10]===-1)W.projectionMatrix.copy(st.projectionMatrix),W.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{const K=bt+Q,$=Jt+Q,St=J-rt,E=nt+(mt-rt),g=R*Jt/$*K,U=D*Jt/$*K;W.projectionMatrix.makePerspective(St,E,g,U,K,$),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function ct(W,st){st===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices(st.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(s===null)return;let st=W.near,xt=W.far;v.texture!==null&&(v.depthNear>0&&(st=v.depthNear),v.depthFar>0&&(xt=v.depthFar)),S.near=L.near=C.near=st,S.far=L.far=C.far=xt,(I!==S.near||F!==S.far)&&(s.updateRenderState({depthNear:S.near,depthFar:S.far}),I=S.near,F=S.far),C.layers.mask=W.layers.mask|2,L.layers.mask=W.layers.mask|4,S.layers.mask=C.layers.mask|L.layers.mask;const mt=W.parent,ft=S.cameras;ct(S,mt);for(let zt=0;zt<ft.length;zt++)ct(ft[zt],mt);ft.length===2?V(S,C,L):S.projectionMatrix.copy(C.projectionMatrix),it(W,S,mt)};function it(W,st,xt){xt===null?W.matrix.copy(st.matrixWorld):(W.matrix.copy(xt.matrixWorld),W.matrix.invert(),W.matrix.multiply(st.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy(st.projectionMatrix),W.projectionMatrixInverse.copy(st.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=Tr*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(W){l=W,d!==null&&(d.fixedFoveation=W),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=W)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(S)};let lt=null;function ht(W,st){if(u=st.getViewerPose(c||o),_=st,u!==null){const xt=u.views;p!==null&&(t.setRenderTargetFramebuffer(w,p.framebuffer),t.setRenderTarget(w));let mt=!1;xt.length!==S.cameras.length&&(S.cameras.length=0,mt=!0);for(let bt=0;bt<xt.length;bt++){const Jt=xt[bt];let R=null;if(p!==null)R=p.getViewport(Jt);else{const M=h.getViewSubImage(d,Jt);R=M.viewport,bt===0&&(t.setRenderTargetTextures(w,M.colorTexture,M.depthStencilTexture),t.setRenderTarget(w))}let D=A[bt];D===void 0&&(D=new en,D.layers.enable(bt),D.viewport=new Ee,A[bt]=D),D.matrix.fromArray(Jt.transform.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale),D.projectionMatrix.fromArray(Jt.projectionMatrix),D.projectionMatrixInverse.copy(D.projectionMatrix).invert(),D.viewport.set(R.x,R.y,R.width,R.height),bt===0&&(S.matrix.copy(D.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),mt===!0&&S.cameras.push(D)}const ft=s.enabledFeatures;if(ft&&ft.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&h){const bt=h.getDepthInformation(xt[0]);bt&&bt.isValid&&bt.texture&&v.init(t,bt,s.renderState)}}for(let xt=0;xt<b.length;xt++){const mt=x[xt],ft=b[xt];mt!==null&&ft!==void 0&&ft.update(mt,st,c||o)}lt&&lt(W,st),st.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:st}),_=null}const Nt=new Fd;Nt.setAnimationLoop(ht),this.setAnimationLoop=function(W){lt=W},this.dispose=function(){}}}const Bi=new Hn,WS=new Se;function XS(n,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,Cd(n)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,w,b,x){f.isMeshBasicMaterial||f.isMeshLambertMaterial?r(m,f):f.isMeshToonMaterial?(r(m,f),h(m,f)):f.isMeshPhongMaterial?(r(m,f),u(m,f)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,x)):f.isMeshMatcapMaterial?(r(m,f),_(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),v(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(o(m,f),f.isLineDashedMaterial&&a(m,f)):f.isPointsMaterial?l(m,f,w,b):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Be&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Be&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const w=t.get(f),b=w.envMap,x=w.envMapRotation;b&&(m.envMap.value=b,Bi.copy(x),Bi.x*=-1,Bi.y*=-1,Bi.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Bi.y*=-1,Bi.z*=-1),m.envMapRotation.value.setFromMatrix4(WS.makeRotationFromEuler(Bi)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function o(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function a(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,w,b){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*w,m.scale.value=b*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function h(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,w){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Be&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const w=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function YS(n,t,e,i){let s={},r={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){const x=b.program;i.uniformBlockBinding(w,x)}function c(w,b){let x=s[w.id];x===void 0&&(_(w),x=u(w),s[w.id]=x,w.addEventListener("dispose",m));const T=b.program;i.updateUBOMapping(w,T);const P=t.render.frame;r[w.id]!==P&&(d(w),r[w.id]=P)}function u(w){const b=h();w.__bindingPointIndex=b;const x=n.createBuffer(),T=w.__size,P=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,x),n.bufferData(n.UNIFORM_BUFFER,T,P),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,x),x}function h(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){const b=s[w.id],x=w.uniforms,T=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let P=0,C=x.length;P<C;P++){const L=Array.isArray(x[P])?x[P]:[x[P]];for(let A=0,S=L.length;A<S;A++){const I=L[A];if(p(I,P,A,T)===!0){const F=I.__offset,O=Array.isArray(I.value)?I.value:[I.value];let Y=0;for(let tt=0;tt<O.length;tt++){const G=O[tt],Z=v(G);typeof G=="number"||typeof G=="boolean"?(I.__data[0]=G,n.bufferSubData(n.UNIFORM_BUFFER,F+Y,I.__data)):G.isMatrix3?(I.__data[0]=G.elements[0],I.__data[1]=G.elements[1],I.__data[2]=G.elements[2],I.__data[3]=0,I.__data[4]=G.elements[3],I.__data[5]=G.elements[4],I.__data[6]=G.elements[5],I.__data[7]=0,I.__data[8]=G.elements[6],I.__data[9]=G.elements[7],I.__data[10]=G.elements[8],I.__data[11]=0):(G.toArray(I.__data,Y),Y+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,F,I.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,b,x,T){const P=w.value,C=b+"_"+x;if(T[C]===void 0)return typeof P=="number"||typeof P=="boolean"?T[C]=P:T[C]=P.clone(),!0;{const L=T[C];if(typeof P=="number"||typeof P=="boolean"){if(L!==P)return T[C]=P,!0}else if(L.equals(P)===!1)return L.copy(P),!0}return!1}function _(w){const b=w.uniforms;let x=0;const T=16;for(let C=0,L=b.length;C<L;C++){const A=Array.isArray(b[C])?b[C]:[b[C]];for(let S=0,I=A.length;S<I;S++){const F=A[S],O=Array.isArray(F.value)?F.value:[F.value];for(let Y=0,tt=O.length;Y<tt;Y++){const G=O[Y],Z=v(G),V=x%T,ct=V%Z.boundary,it=V+ct;x+=ct,it!==0&&T-it<Z.storage&&(x+=T-it),F.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=x,x+=Z.storage}}}const P=x%T;return P>0&&(x+=T-P),w.__size=x,w.__cache={},this}function v(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){const b=w.target;b.removeEventListener("dispose",m);const x=o.indexOf(b.__bindingPointIndex);o.splice(x,1),n.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function f(){for(const w in s)n.deleteBuffer(s[w]);o=[],s={},r={}}return{bind:l,update:c,dispose:f}}class Yc{constructor(t={}){const{canvas:e=E_(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const _=new Uint32Array(4),v=new Int32Array(4);let m=null,f=null;const w=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ti,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let T=!1;this._outputColorSpace=dn;let P=0,C=0,L=null,A=-1,S=null;const I=new Ee,F=new Ee;let O=null;const Y=new Yt(0);let tt=0,G=e.width,Z=e.height,V=1,ct=null,it=null;const lt=new Ee(0,0,G,Z),ht=new Ee(0,0,G,Z);let Nt=!1;const W=new Ud;let st=!1,xt=!1;const mt=new Se,ft=new Se,zt=new H,bt=new Ee,Jt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let R=!1;function D(){return L===null?V:1}let M=i;function ot(y,B){return e.getContext(y,B)}try{const y={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Cc}`),e.addEventListener("webglcontextlost",Pt,!1),e.addEventListener("webglcontextrestored",pt,!1),e.addEventListener("webglcontextcreationerror",at,!1),M===null){const B="webgl2";if(M=ot(B,y),M===null)throw ot(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(y){throw console.error("THREE.WebGLRenderer: "+y.message),y}let J,nt,Q,rt,K,$,St,E,g,U,X,et,k,At,_t,Tt,Rt,ut,wt,Dt,It,vt,Xt,N;function yt(){J=new iM(M),J.init(),vt=new zS(M,J),nt=new $x(M,J,t,vt),Q=new OS(M,J),nt.reverseDepthBuffer&&d&&Q.buffers.depth.setReversed(!0),rt=new oM(M),K=new AS,$=new BS(M,J,Q,K,nt,vt,rt),St=new Jx(x),E=new nM(x),g=new fv(M),Xt=new jx(M,g),U=new sM(M,g,rt,Xt),X=new lM(M,U,g,rt),wt=new aM(M,nt,$),Tt=new Kx(K),et=new ES(x,St,E,J,nt,Xt,Tt),k=new XS(x,K),At=new bS,_t=new IS(J),ut=new qx(x,St,E,Q,X,p,l),Rt=new NS(x,X,nt),N=new YS(M,rt,nt,Q),Dt=new Zx(M,J,rt),It=new rM(M,J,rt),rt.programs=et.programs,x.capabilities=nt,x.extensions=J,x.properties=K,x.renderLists=At,x.shadowMap=Rt,x.state=Q,x.info=rt}yt();const dt=new kS(x,M);this.xr=dt,this.getContext=function(){return M},this.getContextAttributes=function(){return M.getContextAttributes()},this.forceContextLoss=function(){const y=J.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=J.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(y){y!==void 0&&(V=y,this.setSize(G,Z,!1))},this.getSize=function(y){return y.set(G,Z)},this.setSize=function(y,B,q=!0){if(dt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=y,Z=B,e.width=Math.floor(y*V),e.height=Math.floor(B*V),q===!0&&(e.style.width=y+"px",e.style.height=B+"px"),this.setViewport(0,0,y,B)},this.getDrawingBufferSize=function(y){return y.set(G*V,Z*V).floor()},this.setDrawingBufferSize=function(y,B,q){G=y,Z=B,V=q,e.width=Math.floor(y*q),e.height=Math.floor(B*q),this.setViewport(0,0,y,B)},this.getCurrentViewport=function(y){return y.copy(I)},this.getViewport=function(y){return y.copy(lt)},this.setViewport=function(y,B,q,j){y.isVector4?lt.set(y.x,y.y,y.z,y.w):lt.set(y,B,q,j),Q.viewport(I.copy(lt).multiplyScalar(V).round())},this.getScissor=function(y){return y.copy(ht)},this.setScissor=function(y,B,q,j){y.isVector4?ht.set(y.x,y.y,y.z,y.w):ht.set(y,B,q,j),Q.scissor(F.copy(ht).multiplyScalar(V).round())},this.getScissorTest=function(){return Nt},this.setScissorTest=function(y){Q.setScissorTest(Nt=y)},this.setOpaqueSort=function(y){ct=y},this.setTransparentSort=function(y){it=y},this.getClearColor=function(y){return y.copy(ut.getClearColor())},this.setClearColor=function(){ut.setClearColor(...arguments)},this.getClearAlpha=function(){return ut.getClearAlpha()},this.setClearAlpha=function(){ut.setClearAlpha(...arguments)},this.clear=function(y=!0,B=!0,q=!0){let j=0;if(y){let z=!1;if(L!==null){const gt=L.texture.format;z=gt===Nc||gt===Uc||gt===Lc}if(z){const gt=L.texture.type,Et=gt===ui||gt===Zi||gt===Sr||gt===yr||gt===Dc||gt===Ic,Ut=ut.getClearColor(),Ct=ut.getClearAlpha(),Gt=Ut.r,Wt=Ut.g,Ft=Ut.b;Et?(_[0]=Gt,_[1]=Wt,_[2]=Ft,_[3]=Ct,M.clearBufferuiv(M.COLOR,0,_)):(v[0]=Gt,v[1]=Wt,v[2]=Ft,v[3]=Ct,M.clearBufferiv(M.COLOR,0,v))}else j|=M.COLOR_BUFFER_BIT}B&&(j|=M.DEPTH_BUFFER_BIT),q&&(j|=M.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),M.clear(j)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Pt,!1),e.removeEventListener("webglcontextrestored",pt,!1),e.removeEventListener("webglcontextcreationerror",at,!1),ut.dispose(),At.dispose(),_t.dispose(),K.dispose(),St.dispose(),E.dispose(),X.dispose(),Xt.dispose(),N.dispose(),et.dispose(),dt.dispose(),dt.removeEventListener("sessionstart",Qc),dt.removeEventListener("sessionend",tu),Ci.stop()};function Pt(y){y.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function pt(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const y=rt.autoReset,B=Rt.enabled,q=Rt.autoUpdate,j=Rt.needsUpdate,z=Rt.type;yt(),rt.autoReset=y,Rt.enabled=B,Rt.autoUpdate=q,Rt.needsUpdate=j,Rt.type=z}function at(y){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function Lt(y){const B=y.target;B.removeEventListener("dispose",Lt),qt(B)}function qt(y){pe(y),K.remove(y)}function pe(y){const B=K.get(y).programs;B!==void 0&&(B.forEach(function(q){et.releaseProgram(q)}),y.isShaderMaterial&&et.releaseShaderCache(y))}this.renderBufferDirect=function(y,B,q,j,z,gt){B===null&&(B=Jt);const Et=z.isMesh&&z.matrixWorld.determinant()<0,Ut=qd(y,B,q,j,z);Q.setMaterial(j,Et);let Ct=q.index,Gt=1;if(j.wireframe===!0){if(Ct=U.getWireframeAttribute(q),Ct===void 0)return;Gt=2}const Wt=q.drawRange,Ft=q.attributes.position;let Qt=Wt.start*Gt,le=(Wt.start+Wt.count)*Gt;gt!==null&&(Qt=Math.max(Qt,gt.start*Gt),le=Math.min(le,(gt.start+gt.count)*Gt)),Ct!==null?(Qt=Math.max(Qt,0),le=Math.min(le,Ct.count)):Ft!=null&&(Qt=Math.max(Qt,0),le=Math.min(le,Ft.count));const _e=le-Qt;if(_e<0||_e===1/0)return;Xt.setup(z,j,Ut,q,Ct);let xe,te=Dt;if(Ct!==null&&(xe=g.get(Ct),te=It,te.setIndex(xe)),z.isMesh)j.wireframe===!0?(Q.setLineWidth(j.wireframeLinewidth*D()),te.setMode(M.LINES)):te.setMode(M.TRIANGLES);else if(z.isLine){let Ot=j.linewidth;Ot===void 0&&(Ot=1),Q.setLineWidth(Ot*D()),z.isLineSegments?te.setMode(M.LINES):z.isLineLoop?te.setMode(M.LINE_LOOP):te.setMode(M.LINE_STRIP)}else z.isPoints?te.setMode(M.POINTS):z.isSprite&&te.setMode(M.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)Us("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),te.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(J.get("WEBGL_multi_draw"))te.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Ot=z._multiDrawStarts,De=z._multiDrawCounts,ie=z._multiDrawCount,xn=Ct?g.get(Ct).bytesPerElement:1,ns=K.get(j).currentProgram.getUniforms();for(let sn=0;sn<ie;sn++)ns.setValue(M,"_gl_DrawID",sn),te.render(Ot[sn]/xn,De[sn])}else if(z.isInstancedMesh)te.renderInstances(Qt,_e,z.count);else if(q.isInstancedBufferGeometry){const Ot=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,De=Math.min(q.instanceCount,Ot);te.renderInstances(Qt,_e,De)}else te.render(Qt,_e)};function ae(y,B,q){y.transparent===!0&&y.side===pn&&y.forceSinglePass===!1?(y.side=Be,y.needsUpdate=!0,Nr(y,B,q),y.side=ci,y.needsUpdate=!0,Nr(y,B,q),y.side=pn):Nr(y,B,q)}this.compile=function(y,B,q=null){q===null&&(q=y),f=_t.get(q),f.init(B),b.push(f),q.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(f.pushLight(z),z.castShadow&&f.pushShadow(z))}),y!==q&&y.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(f.pushLight(z),z.castShadow&&f.pushShadow(z))}),f.setupLights();const j=new Set;return y.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const gt=z.material;if(gt)if(Array.isArray(gt))for(let Et=0;Et<gt.length;Et++){const Ut=gt[Et];ae(Ut,q,z),j.add(Ut)}else ae(gt,q,z),j.add(gt)}),f=b.pop(),j},this.compileAsync=function(y,B,q=null){const j=this.compile(y,B,q);return new Promise(z=>{function gt(){if(j.forEach(function(Et){K.get(Et).currentProgram.isReady()&&j.delete(Et)}),j.size===0){z(y);return}setTimeout(gt,10)}J.get("KHR_parallel_shader_compile")!==null?gt():setTimeout(gt,10)})};let vn=null;function Gn(y){vn&&vn(y)}function Qc(){Ci.stop()}function tu(){Ci.start()}const Ci=new Fd;Ci.setAnimationLoop(Gn),typeof self<"u"&&Ci.setContext(self),this.setAnimationLoop=function(y){vn=y,dt.setAnimationLoop(y),y===null?Ci.stop():Ci.start()},dt.addEventListener("sessionstart",Qc),dt.addEventListener("sessionend",tu),this.render=function(y,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),dt.enabled===!0&&dt.isPresenting===!0&&(dt.cameraAutoUpdate===!0&&dt.updateCamera(B),B=dt.getCamera()),y.isScene===!0&&y.onBeforeRender(x,y,B,L),f=_t.get(y,b.length),f.init(B),b.push(f),ft.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),W.setFromProjectionMatrix(ft),xt=this.localClippingEnabled,st=Tt.init(this.clippingPlanes,xt),m=At.get(y,w.length),m.init(),w.push(m),dt.enabled===!0&&dt.isPresenting===!0){const gt=x.xr.getDepthSensingMesh();gt!==null&&ha(gt,B,-1/0,x.sortObjects)}ha(y,B,0,x.sortObjects),m.finish(),x.sortObjects===!0&&m.sort(ct,it),R=dt.enabled===!1||dt.isPresenting===!1||dt.hasDepthSensing()===!1,R&&ut.addToRenderList(m,y),this.info.render.frame++,st===!0&&Tt.beginShadows();const q=f.state.shadowsArray;Rt.render(q,y,B),st===!0&&Tt.endShadows(),this.info.autoReset===!0&&this.info.reset();const j=m.opaque,z=m.transmissive;if(f.setupLights(),B.isArrayCamera){const gt=B.cameras;if(z.length>0)for(let Et=0,Ut=gt.length;Et<Ut;Et++){const Ct=gt[Et];nu(j,z,y,Ct)}R&&ut.render(y);for(let Et=0,Ut=gt.length;Et<Ut;Et++){const Ct=gt[Et];eu(m,y,Ct,Ct.viewport)}}else z.length>0&&nu(j,z,y,B),R&&ut.render(y),eu(m,y,B);L!==null&&C===0&&($.updateMultisampleRenderTarget(L),$.updateRenderTargetMipmap(L)),y.isScene===!0&&y.onAfterRender(x,y,B),Xt.resetDefaultState(),A=-1,S=null,b.pop(),b.length>0?(f=b[b.length-1],st===!0&&Tt.setGlobalState(x.clippingPlanes,f.state.camera)):f=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function ha(y,B,q,j){if(y.visible===!1)return;if(y.layers.test(B.layers)){if(y.isGroup)q=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(B);else if(y.isLight)f.pushLight(y),y.castShadow&&f.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||W.intersectsSprite(y)){j&&bt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(ft);const Et=X.update(y),Ut=y.material;Ut.visible&&m.push(y,Et,Ut,q,bt.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||W.intersectsObject(y))){const Et=X.update(y),Ut=y.material;if(j&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),bt.copy(y.boundingSphere.center)):(Et.boundingSphere===null&&Et.computeBoundingSphere(),bt.copy(Et.boundingSphere.center)),bt.applyMatrix4(y.matrixWorld).applyMatrix4(ft)),Array.isArray(Ut)){const Ct=Et.groups;for(let Gt=0,Wt=Ct.length;Gt<Wt;Gt++){const Ft=Ct[Gt],Qt=Ut[Ft.materialIndex];Qt&&Qt.visible&&m.push(y,Et,Qt,q,bt.z,Ft)}}else Ut.visible&&m.push(y,Et,Ut,q,bt.z,null)}}const gt=y.children;for(let Et=0,Ut=gt.length;Et<Ut;Et++)ha(gt[Et],B,q,j)}function eu(y,B,q,j){const z=y.opaque,gt=y.transmissive,Et=y.transparent;f.setupLightsView(q),st===!0&&Tt.setGlobalState(x.clippingPlanes,q),j&&Q.viewport(I.copy(j)),z.length>0&&Ur(z,B,q),gt.length>0&&Ur(gt,B,q),Et.length>0&&Ur(Et,B,q),Q.buffers.depth.setTest(!0),Q.buffers.depth.setMask(!0),Q.buffers.color.setMask(!0),Q.setPolygonOffset(!1)}function nu(y,B,q,j){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[j.id]===void 0&&(f.state.transmissionRenderTarget[j.id]=new Ki(1,1,{generateMipmaps:!0,type:J.has("EXT_color_buffer_half_float")||J.has("EXT_color_buffer_float")?Dr:ui,minFilter:Wi,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ee.workingColorSpace}));const gt=f.state.transmissionRenderTarget[j.id],Et=j.viewport||I;gt.setSize(Et.z*x.transmissionResolutionScale,Et.w*x.transmissionResolutionScale);const Ut=x.getRenderTarget();x.setRenderTarget(gt),x.getClearColor(Y),tt=x.getClearAlpha(),tt<1&&x.setClearColor(16777215,.5),x.clear(),R&&ut.render(q);const Ct=x.toneMapping;x.toneMapping=Ti;const Gt=j.viewport;if(j.viewport!==void 0&&(j.viewport=void 0),f.setupLightsView(j),st===!0&&Tt.setGlobalState(x.clippingPlanes,j),Ur(y,q,j),$.updateMultisampleRenderTarget(gt),$.updateRenderTargetMipmap(gt),J.has("WEBGL_multisampled_render_to_texture")===!1){let Wt=!1;for(let Ft=0,Qt=B.length;Ft<Qt;Ft++){const le=B[Ft],_e=le.object,xe=le.geometry,te=le.material,Ot=le.group;if(te.side===pn&&_e.layers.test(j.layers)){const De=te.side;te.side=Be,te.needsUpdate=!0,iu(_e,q,j,xe,te,Ot),te.side=De,te.needsUpdate=!0,Wt=!0}}Wt===!0&&($.updateMultisampleRenderTarget(gt),$.updateRenderTargetMipmap(gt))}x.setRenderTarget(Ut),x.setClearColor(Y,tt),Gt!==void 0&&(j.viewport=Gt),x.toneMapping=Ct}function Ur(y,B,q){const j=B.isScene===!0?B.overrideMaterial:null;for(let z=0,gt=y.length;z<gt;z++){const Et=y[z],Ut=Et.object,Ct=Et.geometry,Gt=Et.group;let Wt=Et.material;Wt.allowOverride===!0&&j!==null&&(Wt=j),Ut.layers.test(q.layers)&&iu(Ut,B,q,Ct,Wt,Gt)}}function iu(y,B,q,j,z,gt){y.onBeforeRender(x,B,q,j,z,gt),y.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),z.onBeforeRender(x,B,q,j,y,gt),z.transparent===!0&&z.side===pn&&z.forceSinglePass===!1?(z.side=Be,z.needsUpdate=!0,x.renderBufferDirect(q,B,j,z,y,gt),z.side=ci,z.needsUpdate=!0,x.renderBufferDirect(q,B,j,z,y,gt),z.side=pn):x.renderBufferDirect(q,B,j,z,y,gt),y.onAfterRender(x,B,q,j,z,gt)}function Nr(y,B,q){B.isScene!==!0&&(B=Jt);const j=K.get(y),z=f.state.lights,gt=f.state.shadowsArray,Et=z.state.version,Ut=et.getParameters(y,z.state,gt,B,q),Ct=et.getProgramCacheKey(Ut);let Gt=j.programs;j.environment=y.isMeshStandardMaterial?B.environment:null,j.fog=B.fog,j.envMap=(y.isMeshStandardMaterial?E:St).get(y.envMap||j.environment),j.envMapRotation=j.environment!==null&&y.envMap===null?B.environmentRotation:y.envMapRotation,Gt===void 0&&(y.addEventListener("dispose",Lt),Gt=new Map,j.programs=Gt);let Wt=Gt.get(Ct);if(Wt!==void 0){if(j.currentProgram===Wt&&j.lightsStateVersion===Et)return ru(y,Ut),Wt}else Ut.uniforms=et.getUniforms(y),y.onBeforeCompile(Ut,x),Wt=et.acquireProgram(Ut,Ct),Gt.set(Ct,Wt),j.uniforms=Ut.uniforms;const Ft=j.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Ft.clippingPlanes=Tt.uniform),ru(y,Ut),j.needsLights=Zd(y),j.lightsStateVersion=Et,j.needsLights&&(Ft.ambientLightColor.value=z.state.ambient,Ft.lightProbe.value=z.state.probe,Ft.directionalLights.value=z.state.directional,Ft.directionalLightShadows.value=z.state.directionalShadow,Ft.spotLights.value=z.state.spot,Ft.spotLightShadows.value=z.state.spotShadow,Ft.rectAreaLights.value=z.state.rectArea,Ft.ltc_1.value=z.state.rectAreaLTC1,Ft.ltc_2.value=z.state.rectAreaLTC2,Ft.pointLights.value=z.state.point,Ft.pointLightShadows.value=z.state.pointShadow,Ft.hemisphereLights.value=z.state.hemi,Ft.directionalShadowMap.value=z.state.directionalShadowMap,Ft.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Ft.spotShadowMap.value=z.state.spotShadowMap,Ft.spotLightMatrix.value=z.state.spotLightMatrix,Ft.spotLightMap.value=z.state.spotLightMap,Ft.pointShadowMap.value=z.state.pointShadowMap,Ft.pointShadowMatrix.value=z.state.pointShadowMatrix),j.currentProgram=Wt,j.uniformsList=null,Wt}function su(y){if(y.uniformsList===null){const B=y.currentProgram.getUniforms();y.uniformsList=bo.seqWithValue(B.seq,y.uniforms)}return y.uniformsList}function ru(y,B){const q=K.get(y);q.outputColorSpace=B.outputColorSpace,q.batching=B.batching,q.batchingColor=B.batchingColor,q.instancing=B.instancing,q.instancingColor=B.instancingColor,q.instancingMorph=B.instancingMorph,q.skinning=B.skinning,q.morphTargets=B.morphTargets,q.morphNormals=B.morphNormals,q.morphColors=B.morphColors,q.morphTargetsCount=B.morphTargetsCount,q.numClippingPlanes=B.numClippingPlanes,q.numIntersection=B.numClipIntersection,q.vertexAlphas=B.vertexAlphas,q.vertexTangents=B.vertexTangents,q.toneMapping=B.toneMapping}function qd(y,B,q,j,z){B.isScene!==!0&&(B=Jt),$.resetTextureUnits();const gt=B.fog,Et=j.isMeshStandardMaterial?B.environment:null,Ut=L===null?x.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:Hs,Ct=(j.isMeshStandardMaterial?E:St).get(j.envMap||Et),Gt=j.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Wt=!!q.attributes.tangent&&(!!j.normalMap||j.anisotropy>0),Ft=!!q.morphAttributes.position,Qt=!!q.morphAttributes.normal,le=!!q.morphAttributes.color;let _e=Ti;j.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(_e=x.toneMapping);const xe=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,te=xe!==void 0?xe.length:0,Ot=K.get(j),De=f.state.lights;if(st===!0&&(xt===!0||y!==S)){const Ge=y===S&&j.id===A;Tt.setState(j,y,Ge)}let ie=!1;j.version===Ot.__version?(Ot.needsLights&&Ot.lightsStateVersion!==De.state.version||Ot.outputColorSpace!==Ut||z.isBatchedMesh&&Ot.batching===!1||!z.isBatchedMesh&&Ot.batching===!0||z.isBatchedMesh&&Ot.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&Ot.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&Ot.instancing===!1||!z.isInstancedMesh&&Ot.instancing===!0||z.isSkinnedMesh&&Ot.skinning===!1||!z.isSkinnedMesh&&Ot.skinning===!0||z.isInstancedMesh&&Ot.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&Ot.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&Ot.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&Ot.instancingMorph===!1&&z.morphTexture!==null||Ot.envMap!==Ct||j.fog===!0&&Ot.fog!==gt||Ot.numClippingPlanes!==void 0&&(Ot.numClippingPlanes!==Tt.numPlanes||Ot.numIntersection!==Tt.numIntersection)||Ot.vertexAlphas!==Gt||Ot.vertexTangents!==Wt||Ot.morphTargets!==Ft||Ot.morphNormals!==Qt||Ot.morphColors!==le||Ot.toneMapping!==_e||Ot.morphTargetsCount!==te)&&(ie=!0):(ie=!0,Ot.__version=j.version);let xn=Ot.currentProgram;ie===!0&&(xn=Nr(j,B,z));let ns=!1,sn=!1,Ys=!1;const me=xn.getUniforms(),un=Ot.uniforms;if(Q.useProgram(xn.program)&&(ns=!0,sn=!0,Ys=!0),j.id!==A&&(A=j.id,sn=!0),ns||S!==y){Q.buffers.depth.getReversed()?(mt.copy(y.projectionMatrix),T_(mt),b_(mt),me.setValue(M,"projectionMatrix",mt)):me.setValue(M,"projectionMatrix",y.projectionMatrix),me.setValue(M,"viewMatrix",y.matrixWorldInverse);const Je=me.map.cameraPosition;Je!==void 0&&Je.setValue(M,zt.setFromMatrixPosition(y.matrixWorld)),nt.logarithmicDepthBuffer&&me.setValue(M,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(j.isMeshPhongMaterial||j.isMeshToonMaterial||j.isMeshLambertMaterial||j.isMeshBasicMaterial||j.isMeshStandardMaterial||j.isShaderMaterial)&&me.setValue(M,"isOrthographic",y.isOrthographicCamera===!0),S!==y&&(S=y,sn=!0,Ys=!0)}if(z.isSkinnedMesh){me.setOptional(M,z,"bindMatrix"),me.setOptional(M,z,"bindMatrixInverse");const Ge=z.skeleton;Ge&&(Ge.boneTexture===null&&Ge.computeBoneTexture(),me.setValue(M,"boneTexture",Ge.boneTexture,$))}z.isBatchedMesh&&(me.setOptional(M,z,"batchingTexture"),me.setValue(M,"batchingTexture",z._matricesTexture,$),me.setOptional(M,z,"batchingIdTexture"),me.setValue(M,"batchingIdTexture",z._indirectTexture,$),me.setOptional(M,z,"batchingColorTexture"),z._colorsTexture!==null&&me.setValue(M,"batchingColorTexture",z._colorsTexture,$));const hn=q.morphAttributes;if((hn.position!==void 0||hn.normal!==void 0||hn.color!==void 0)&&wt.update(z,q,xn),(sn||Ot.receiveShadow!==z.receiveShadow)&&(Ot.receiveShadow=z.receiveShadow,me.setValue(M,"receiveShadow",z.receiveShadow)),j.isMeshGouraudMaterial&&j.envMap!==null&&(un.envMap.value=Ct,un.flipEnvMap.value=Ct.isCubeTexture&&Ct.isRenderTargetTexture===!1?-1:1),j.isMeshStandardMaterial&&j.envMap===null&&B.environment!==null&&(un.envMapIntensity.value=B.environmentIntensity),sn&&(me.setValue(M,"toneMappingExposure",x.toneMappingExposure),Ot.needsLights&&jd(un,Ys),gt&&j.fog===!0&&k.refreshFogUniforms(un,gt),k.refreshMaterialUniforms(un,j,V,Z,f.state.transmissionRenderTarget[y.id]),bo.upload(M,su(Ot),un,$)),j.isShaderMaterial&&j.uniformsNeedUpdate===!0&&(bo.upload(M,su(Ot),un,$),j.uniformsNeedUpdate=!1),j.isSpriteMaterial&&me.setValue(M,"center",z.center),me.setValue(M,"modelViewMatrix",z.modelViewMatrix),me.setValue(M,"normalMatrix",z.normalMatrix),me.setValue(M,"modelMatrix",z.matrixWorld),j.isShaderMaterial||j.isRawShaderMaterial){const Ge=j.uniformsGroups;for(let Je=0,fa=Ge.length;Je<fa;Je++){const Pi=Ge[Je];N.update(Pi,xn),N.bind(Pi,xn)}}return xn}function jd(y,B){y.ambientLightColor.needsUpdate=B,y.lightProbe.needsUpdate=B,y.directionalLights.needsUpdate=B,y.directionalLightShadows.needsUpdate=B,y.pointLights.needsUpdate=B,y.pointLightShadows.needsUpdate=B,y.spotLights.needsUpdate=B,y.spotLightShadows.needsUpdate=B,y.rectAreaLights.needsUpdate=B,y.hemisphereLights.needsUpdate=B}function Zd(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(y,B,q){const j=K.get(y);j.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,j.__autoAllocateDepthBuffer===!1&&(j.__useRenderToTexture=!1),K.get(y.texture).__webglTexture=B,K.get(y.depthTexture).__webglTexture=j.__autoAllocateDepthBuffer?void 0:q,j.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,B){const q=K.get(y);q.__webglFramebuffer=B,q.__useDefaultFramebuffer=B===void 0};const $d=M.createFramebuffer();this.setRenderTarget=function(y,B=0,q=0){L=y,P=B,C=q;let j=!0,z=null,gt=!1,Et=!1;if(y){const Ct=K.get(y);if(Ct.__useDefaultFramebuffer!==void 0)Q.bindFramebuffer(M.FRAMEBUFFER,null),j=!1;else if(Ct.__webglFramebuffer===void 0)$.setupRenderTarget(y);else if(Ct.__hasExternalTextures)$.rebindTextures(y,K.get(y.texture).__webglTexture,K.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const Ft=y.depthTexture;if(Ct.__boundDepthTexture!==Ft){if(Ft!==null&&K.has(Ft)&&(y.width!==Ft.image.width||y.height!==Ft.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");$.setupDepthRenderbuffer(y)}}const Gt=y.texture;(Gt.isData3DTexture||Gt.isDataArrayTexture||Gt.isCompressedArrayTexture)&&(Et=!0);const Wt=K.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Wt[B])?z=Wt[B][q]:z=Wt[B],gt=!0):y.samples>0&&$.useMultisampledRTT(y)===!1?z=K.get(y).__webglMultisampledFramebuffer:Array.isArray(Wt)?z=Wt[q]:z=Wt,I.copy(y.viewport),F.copy(y.scissor),O=y.scissorTest}else I.copy(lt).multiplyScalar(V).floor(),F.copy(ht).multiplyScalar(V).floor(),O=Nt;if(q!==0&&(z=$d),Q.bindFramebuffer(M.FRAMEBUFFER,z)&&j&&Q.drawBuffers(y,z),Q.viewport(I),Q.scissor(F),Q.setScissorTest(O),gt){const Ct=K.get(y.texture);M.framebufferTexture2D(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_CUBE_MAP_POSITIVE_X+B,Ct.__webglTexture,q)}else if(Et){const Ct=K.get(y.texture),Gt=B;M.framebufferTextureLayer(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0,Ct.__webglTexture,q,Gt)}else if(y!==null&&q!==0){const Ct=K.get(y.texture);M.framebufferTexture2D(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,Ct.__webglTexture,q)}A=-1},this.readRenderTargetPixels=function(y,B,q,j,z,gt,Et,Ut=0){if(!(y&&y.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ct=K.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Et!==void 0&&(Ct=Ct[Et]),Ct){Q.bindFramebuffer(M.FRAMEBUFFER,Ct);try{const Gt=y.textures[Ut],Wt=Gt.format,Ft=Gt.type;if(!nt.textureFormatReadable(Wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=y.width-j&&q>=0&&q<=y.height-z&&(y.textures.length>1&&M.readBuffer(M.COLOR_ATTACHMENT0+Ut),M.readPixels(B,q,j,z,vt.convert(Wt),vt.convert(Ft),gt))}finally{const Gt=L!==null?K.get(L).__webglFramebuffer:null;Q.bindFramebuffer(M.FRAMEBUFFER,Gt)}}},this.readRenderTargetPixelsAsync=async function(y,B,q,j,z,gt,Et,Ut=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ct=K.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Et!==void 0&&(Ct=Ct[Et]),Ct)if(B>=0&&B<=y.width-j&&q>=0&&q<=y.height-z){Q.bindFramebuffer(M.FRAMEBUFFER,Ct);const Gt=y.textures[Ut],Wt=Gt.format,Ft=Gt.type;if(!nt.textureFormatReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qt=M.createBuffer();M.bindBuffer(M.PIXEL_PACK_BUFFER,Qt),M.bufferData(M.PIXEL_PACK_BUFFER,gt.byteLength,M.STREAM_READ),y.textures.length>1&&M.readBuffer(M.COLOR_ATTACHMENT0+Ut),M.readPixels(B,q,j,z,vt.convert(Wt),vt.convert(Ft),0);const le=L!==null?K.get(L).__webglFramebuffer:null;Q.bindFramebuffer(M.FRAMEBUFFER,le);const _e=M.fenceSync(M.SYNC_GPU_COMMANDS_COMPLETE,0);return M.flush(),await A_(M,_e,4),M.bindBuffer(M.PIXEL_PACK_BUFFER,Qt),M.getBufferSubData(M.PIXEL_PACK_BUFFER,0,gt),M.deleteBuffer(Qt),M.deleteSync(_e),gt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,B=null,q=0){const j=Math.pow(2,-q),z=Math.floor(y.image.width*j),gt=Math.floor(y.image.height*j),Et=B!==null?B.x:0,Ut=B!==null?B.y:0;$.setTexture2D(y,0),M.copyTexSubImage2D(M.TEXTURE_2D,q,0,0,Et,Ut,z,gt),Q.unbindTexture()};const Kd=M.createFramebuffer(),Jd=M.createFramebuffer();this.copyTextureToTexture=function(y,B,q=null,j=null,z=0,gt=null){gt===null&&(z!==0?(Us("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),gt=z,z=0):gt=0);let Et,Ut,Ct,Gt,Wt,Ft,Qt,le,_e;const xe=y.isCompressedTexture?y.mipmaps[gt]:y.image;if(q!==null)Et=q.max.x-q.min.x,Ut=q.max.y-q.min.y,Ct=q.isBox3?q.max.z-q.min.z:1,Gt=q.min.x,Wt=q.min.y,Ft=q.isBox3?q.min.z:0;else{const hn=Math.pow(2,-z);Et=Math.floor(xe.width*hn),Ut=Math.floor(xe.height*hn),y.isDataArrayTexture?Ct=xe.depth:y.isData3DTexture?Ct=Math.floor(xe.depth*hn):Ct=1,Gt=0,Wt=0,Ft=0}j!==null?(Qt=j.x,le=j.y,_e=j.z):(Qt=0,le=0,_e=0);const te=vt.convert(B.format),Ot=vt.convert(B.type);let De;B.isData3DTexture?($.setTexture3D(B,0),De=M.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?($.setTexture2DArray(B,0),De=M.TEXTURE_2D_ARRAY):($.setTexture2D(B,0),De=M.TEXTURE_2D),M.pixelStorei(M.UNPACK_FLIP_Y_WEBGL,B.flipY),M.pixelStorei(M.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),M.pixelStorei(M.UNPACK_ALIGNMENT,B.unpackAlignment);const ie=M.getParameter(M.UNPACK_ROW_LENGTH),xn=M.getParameter(M.UNPACK_IMAGE_HEIGHT),ns=M.getParameter(M.UNPACK_SKIP_PIXELS),sn=M.getParameter(M.UNPACK_SKIP_ROWS),Ys=M.getParameter(M.UNPACK_SKIP_IMAGES);M.pixelStorei(M.UNPACK_ROW_LENGTH,xe.width),M.pixelStorei(M.UNPACK_IMAGE_HEIGHT,xe.height),M.pixelStorei(M.UNPACK_SKIP_PIXELS,Gt),M.pixelStorei(M.UNPACK_SKIP_ROWS,Wt),M.pixelStorei(M.UNPACK_SKIP_IMAGES,Ft);const me=y.isDataArrayTexture||y.isData3DTexture,un=B.isDataArrayTexture||B.isData3DTexture;if(y.isDepthTexture){const hn=K.get(y),Ge=K.get(B),Je=K.get(hn.__renderTarget),fa=K.get(Ge.__renderTarget);Q.bindFramebuffer(M.READ_FRAMEBUFFER,Je.__webglFramebuffer),Q.bindFramebuffer(M.DRAW_FRAMEBUFFER,fa.__webglFramebuffer);for(let Pi=0;Pi<Ct;Pi++)me&&(M.framebufferTextureLayer(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,K.get(y).__webglTexture,z,Ft+Pi),M.framebufferTextureLayer(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,K.get(B).__webglTexture,gt,_e+Pi)),M.blitFramebuffer(Gt,Wt,Et,Ut,Qt,le,Et,Ut,M.DEPTH_BUFFER_BIT,M.NEAREST);Q.bindFramebuffer(M.READ_FRAMEBUFFER,null),Q.bindFramebuffer(M.DRAW_FRAMEBUFFER,null)}else if(z!==0||y.isRenderTargetTexture||K.has(y)){const hn=K.get(y),Ge=K.get(B);Q.bindFramebuffer(M.READ_FRAMEBUFFER,Kd),Q.bindFramebuffer(M.DRAW_FRAMEBUFFER,Jd);for(let Je=0;Je<Ct;Je++)me?M.framebufferTextureLayer(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,hn.__webglTexture,z,Ft+Je):M.framebufferTexture2D(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,hn.__webglTexture,z),un?M.framebufferTextureLayer(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,Ge.__webglTexture,gt,_e+Je):M.framebufferTexture2D(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,Ge.__webglTexture,gt),z!==0?M.blitFramebuffer(Gt,Wt,Et,Ut,Qt,le,Et,Ut,M.COLOR_BUFFER_BIT,M.NEAREST):un?M.copyTexSubImage3D(De,gt,Qt,le,_e+Je,Gt,Wt,Et,Ut):M.copyTexSubImage2D(De,gt,Qt,le,Gt,Wt,Et,Ut);Q.bindFramebuffer(M.READ_FRAMEBUFFER,null),Q.bindFramebuffer(M.DRAW_FRAMEBUFFER,null)}else un?y.isDataTexture||y.isData3DTexture?M.texSubImage3D(De,gt,Qt,le,_e,Et,Ut,Ct,te,Ot,xe.data):B.isCompressedArrayTexture?M.compressedTexSubImage3D(De,gt,Qt,le,_e,Et,Ut,Ct,te,xe.data):M.texSubImage3D(De,gt,Qt,le,_e,Et,Ut,Ct,te,Ot,xe):y.isDataTexture?M.texSubImage2D(M.TEXTURE_2D,gt,Qt,le,Et,Ut,te,Ot,xe.data):y.isCompressedTexture?M.compressedTexSubImage2D(M.TEXTURE_2D,gt,Qt,le,xe.width,xe.height,te,xe.data):M.texSubImage2D(M.TEXTURE_2D,gt,Qt,le,Et,Ut,te,Ot,xe);M.pixelStorei(M.UNPACK_ROW_LENGTH,ie),M.pixelStorei(M.UNPACK_IMAGE_HEIGHT,xn),M.pixelStorei(M.UNPACK_SKIP_PIXELS,ns),M.pixelStorei(M.UNPACK_SKIP_ROWS,sn),M.pixelStorei(M.UNPACK_SKIP_IMAGES,Ys),gt===0&&B.generateMipmaps&&M.generateMipmap(De),Q.unbindTexture()},this.copyTextureToTexture3D=function(y,B,q=null,j=null,z=0){return Us('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(y,B,q,j,z)},this.initRenderTarget=function(y){K.get(y).__webglFramebuffer===void 0&&$.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?$.setTextureCube(y,0):y.isData3DTexture?$.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?$.setTexture2DArray(y,0):$.setTexture2D(y,0),Q.unbindTexture()},this.resetState=function(){P=0,C=0,L=null,Q.reset(),Xt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ni}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=ee._getDrawingBufferColorSpace(t),e.unpackColorSpace=ee._getUnpackColorSpace()}}const Bh={type:"change"},qc={type:"start"},Vd={type:"end"},fo=new Bc,zh=new Mi,qS=Math.cos(70*rr.DEG2RAD),be=new H,Qe=2*Math.PI,he={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},nl=1e-6;class jc extends uv{constructor(t,e=null){super(t,e),this.state=he.NONE,this.target=new H,this.cursor=new H,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Is.ROTATE,MIDDLE:Is.DOLLY,RIGHT:Is.PAN},this.touches={ONE:Ts.ROTATE,TWO:Ts.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new H,this._lastQuaternion=new $i,this._lastTargetPosition=new H,this._quat=new $i().setFromUnitVectors(t.up,new H(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new fh,this._sphericalDelta=new fh,this._scale=1,this._panOffset=new H,this._rotateStart=new Ht,this._rotateEnd=new Ht,this._rotateDelta=new Ht,this._panStart=new Ht,this._panEnd=new Ht,this._panDelta=new Ht,this._dollyStart=new Ht,this._dollyEnd=new Ht,this._dollyDelta=new Ht,this._dollyDirection=new H,this._mouse=new Ht,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=ZS.bind(this),this._onPointerDown=jS.bind(this),this._onPointerUp=$S.bind(this),this._onContextMenu=iy.bind(this),this._onMouseWheel=QS.bind(this),this._onKeyDown=ty.bind(this),this._onTouchStart=ey.bind(this),this._onTouchMove=ny.bind(this),this._onMouseDown=KS.bind(this),this._onMouseMove=JS.bind(this),this._interceptControlDown=sy.bind(this),this._interceptControlUp=ry.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Bh),this.update(),this.state=he.NONE}update(t=null){const e=this.object.position;be.copy(e).sub(this.target),be.applyQuaternion(this._quat),this._spherical.setFromVector3(be),this.autoRotate&&this.state===he.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(i)&&isFinite(s)&&(i<-Math.PI?i+=Qe:i>Math.PI&&(i-=Qe),s<-Math.PI?s+=Qe:s>Math.PI&&(s-=Qe),i<=s?this._spherical.theta=Math.max(i,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+s)/2?Math.max(i,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=o!=this._spherical.radius}if(be.setFromSpherical(this._spherical),be.applyQuaternion(this._quatInverse),e.copy(this.target).add(be),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=be.length();o=this._clampDistance(a*this._scale);const l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const a=new H(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new H(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(a),this.object.updateMatrixWorld(),o=be.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(fo.origin.copy(this.object.position),fo.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(fo.direction))<qS?this.object.lookAt(this.target):(zh.setFromNormalAndCoplanarPoint(this.object.up,this.target),fo.intersectPlane(zh,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>nl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>nl||this._lastTargetPosition.distanceToSquared(this.target)>nl?(this.dispatchEvent(Bh),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Qe/60*this.autoRotateSpeed*t:Qe/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){be.setFromMatrixColumn(e,0),be.multiplyScalar(-t),this._panOffset.add(be)}_panUp(t,e){this.screenSpacePanning===!0?be.setFromMatrixColumn(e,1):(be.setFromMatrixColumn(e,0),be.crossVectors(this.object.up,be)),be.multiplyScalar(t),this._panOffset.add(be)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;be.copy(s).sub(this.target);let r=be.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/i.clientHeight,this.object.matrix),this._panUp(2*e*r/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),s=t-i.left,r=e-i.top,o=i.width,a=i.height;this._mouse.x=s/o*2-1,this._mouse.y=-(r/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Qe*this._rotateDelta.x/e.clientHeight),this._rotateUp(Qe*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Qe*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Qe*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Qe*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Qe*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(i,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(i,s)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(i*i+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),r=.5*(t.pageY+i.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Qe*this._rotateDelta.x/e.clientHeight),this._rotateUp(Qe*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(i,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(i*i+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(t.pageX+e.x)*.5,a=(t.pageY+e.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new Ht,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function jS(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function ZS(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function $S(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Vd),this.state=he.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function KS(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Is.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=he.DOLLY;break;case Is.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=he.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=he.ROTATE}break;case Is.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=he.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=he.PAN}break;default:this.state=he.NONE}this.state!==he.NONE&&this.dispatchEvent(qc)}function JS(n){switch(this.state){case he.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case he.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case he.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function QS(n){this.enabled===!1||this.enableZoom===!1||this.state!==he.NONE||(n.preventDefault(),this.dispatchEvent(qc),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(Vd))}function ty(n){this.enabled!==!1&&this._handleKeyDown(n)}function ey(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case Ts.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=he.TOUCH_ROTATE;break;case Ts.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=he.TOUCH_PAN;break;default:this.state=he.NONE}break;case 2:switch(this.touches.TWO){case Ts.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=he.TOUCH_DOLLY_PAN;break;case Ts.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=he.TOUCH_DOLLY_ROTATE;break;default:this.state=he.NONE}break;default:this.state=he.NONE}this.state!==he.NONE&&this.dispatchEvent(qc)}function ny(n){switch(this._trackPointer(n),this.state){case he.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case he.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case he.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case he.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=he.NONE}}function iy(n){this.enabled!==!1&&n.preventDefault()}function sy(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ry(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Hh="SOLAR_VISUAL_MOTION_SIMULATOR_",ne={set(n,t){localStorage.setItem(`${Hh}${n}`,JSON.stringify(t))},get(n){const t=localStorage.getItem(`${Hh}${n}`);return t!==null?JSON.parse(t):null}},oy=(n=new Date)=>23.4393-.013*((n.getFullYear()-2e3)/100),ay=(n=new Date,t)=>{const e=n.getFullYear(),i=t*36e5,s=new Date(e,0,1,0,0,0),r=24*60*60*1e3,o=(n.getTime()-s.getTime()-i)/r,a=79.6764+.2422*(e-1985)-Math.floor((e-1985)/4),l=o-a,c=2*Math.PI*l/365.2422;return .3723+23.2567*Math.sin(c)+.1149*Math.sin(2*c)-.1712*Math.sin(3*c)-.758*Math.cos(c)+.3656*Math.cos(2*c)+.0201*Math.cos(3*c)},ly=(n=new Date,t)=>{const e=n.getFullYear(),i=n.getMonth(),s=n.getDate(),r=new Date(e,i,s,0,0,0);let l=(24*60*60*1e3/2+r.getTime()-n.getTime())/4/6e4+t*15;return l>=180?l-=360:l<-180&&(l+=360),l},cy=(n=new Date,t,e)=>{const i=n.getFullYear(),s=n.getMonth(),r=n.getDate(),o=(t-e*15)*4*6e4,a=new Date(i,s,r,0,0,0),l=24*60*60*1e3;let c=(n.getTime()-a.getTime()+o)/l*360-180;return c>=180?c-=360:c<-180&&(c+=360),c},ac=(n,t,e)=>{const i=n*Math.PI/180,s=t*Math.PI/180,r=e*Math.PI/180;return Math.asin(Math.sin(i)*Math.sin(s)+Math.cos(i)*Math.cos(s)*Math.cos(r))*180/Math.PI},uy=(n,t,e,i)=>{const s=n*Math.PI/180,r=t*Math.PI/180,o=e*Math.PI/180,a=i*Math.PI/180;let l=Math.acos((Math.sin(r)*Math.cos(s)-Math.cos(o)*Math.cos(r)*Math.sin(s))/Math.cos(a));return o>0&&(l=2*Math.PI-l),l*180/Math.PI},hy=(n,t,e,i)=>{const s=t*Math.PI/180,r=e*Math.PI/180,o=i-n/15;let a=!1,l=!1;const c=ac(t,e,0);ac(t,e,-180)>=0?a=!0:c<0&&(l=!0);let h=12,d=12,p=12;if(a)h=24;else if(l)h=0;else{const v=Math.acos(-Math.sin(s)*Math.sin(r)/(Math.cos(s)*Math.cos(r)))*180/Math.PI/15;h=v*2,d=12-v+o,d>=24?d-=24:d<0&&(d+=24),p=12+v+o,p>=24?p-=24:p<0&&(p+=24)}return{polarDay:a,polarNight:l,dayLength:h,sunRise:d,sunSet:p}},fy=(n,t,e=new Date,i)=>{const s=oy(e),r=ay(e,i),o=ly(e,i),a=cy(e,n,i),l=ac(t,r,a),c=uy(t,r,a,l),u=hy(n,t,r,i);return{obliquityOfEcliptic:s,solarDeclination:r,solarRightAscension:o,solarHourAngle:a,solarHeight:l,solarDirection:c,dayLength:u}},lc=new Set,Zc=25;let Jn=1,wr=!0,Yi=ne.get("time_zone")??8,Zo=ne.get("longitude")??116.4,$o=ne.get("latitude")??39.9,yi=new Date(1970,1,0,0,0,0);const Ws=()=>{lc.forEach(n=>n(Wd()))},Xs=n=>(lc.add(n),n(Wd()),()=>lc.delete(n)),dy=n=>{Math.abs(n)<=12&&(Yi=n,ne.set("time_zone",Yi),Ws())},py=n=>{Math.abs(n)<=9&&(wr=!1,Jn=n,Ws())},Gd=n=>{n?(wr=!0,Jn=1):wr=!1,Ws()},my=(n,t)=>{Math.abs(n)<=180&&Math.abs(t)<=90&&(Zo=n,$o=t,ne.set("longitude",Zo),ne.set("latitude",$o),Ws())},gy=n=>{n instanceof Date&&n.getFullYear()>=1970&&n.getFullYear()<=9999&&(Gd(!1),yi=new Date(n.getTime()-Yi*36e5),Ws())};let il=0;const kd=n=>{if(Jn!=0){if(il++,il>=Zc||n)if(il=0,wr){const t=new Date;yi=new Date(t.getTime()+t.getTimezoneOffset()*6e4)}else Math.abs(Jn)==1&&(yi=new Date(yi.getTime()+Jn*1e3));Math.abs(Jn)>1&&(yi=new Date(yi.getTime()+Jn*1e4*Math.pow(4,Math.abs(Jn)-2))),Ws()}};kd(!0);setInterval(kd,1e3/Zc);const Wd=()=>({timeLapse:Jn,timeSync:wr,timeZone:Yi,longitude:Zo,latitude:$o,date:new Date(yi.getTime()+Yi*36e5),fps:Zc,solarData:fy(Zo,$o,new Date(yi.getTime()+Yi*36e5),Yi)}),cc=new Set;let wo=ne.get("is_ground_scene_toggle")??!0,Ro=ne.get("is_earth_scene_toggle")??!1,Co=ne.get("is_information_display_toggle")??!1,Po=ne.get("is_location_control_toggle")??!1,Do=ne.get("is_time_control_toggle")??!1,Io=ne.get("is_sun_trajectory_toggle")??!0,Lo=ne.get("is_pole_star_pointer_toggle")??!0,Uo=ne.get("is_grid_toggle")??!1,No=ne.get("is_pin_toggle")??!0,Fo=ne.get("is_sun_ray_pointer_toggle")??!1;const Vn=()=>{cc.forEach(n=>n(Xd()))},$c=n=>(cc.add(n),n(Xd()),()=>cc.delete(n)),Vh=()=>{wo=!wo,ne.set("is_ground_scene_toggle",wo),Vn()},Gh=()=>{Ro=!Ro,ne.set("is_earth_scene_toggle",Ro),Vn()},kh=()=>{Co=!Co,ne.set("is_information_display_toggle",Co),Vn()},Wh=()=>{Po=!Po,ne.set("is_location_control_toggle",Po),Vn()},Xh=()=>{Do=!Do,ne.set("is_time_control_toggle",Do),Vn()},Yh=()=>{Io=!Io,ne.set("is_sun_trajectory_toggle",Io),Vn()},qh=()=>{Lo=!Lo,ne.set("is_pole_star_pointer_toggle",Lo),Vn()},jh=()=>{Uo=!Uo,ne.set("is_grid_toggle",Uo),Vn()},Zh=()=>{No=!No,ne.set("is_pin_toggle",No),Vn()},$h=()=>{Fo=!Fo,ne.set("is_sun_ray_pointer_toggle",Fo),Vn()},Xd=()=>({isGroundSceneToggle:wo,isEarthSceneToggle:Ro,isInformationDisplayToggle:Co,isLocationControlToggle:Po,isTimeControlToggle:Do,isSunTrajectoryToggle:Io,isPoleStarPointerToggle:Lo,isGridToggle:Uo,isPinToggle:No,isSunRayPointerToggle:Fo}),an=3,_y=.2,Kh=.05,Jh=.02,Qh=.3,vy=.05,po=64,xy=75,My=.1,Sy=100,sl=7.5,yy={__name:"GroundScene",setup(n){const t=kt(null),e=kt({timeZone:8,latitude:0,date:new Date,solarData:{solarDeclination:0,solarHourAngle:0,solarDirection:0,solarHeight:0}}),i=kt({isGroundSceneToggle:!0,isEarthSceneToggle:!1,isSunTrajectoryToggle:!0,isPoleStarPointerToggle:!0}),s={astronomical:new Yt(723757),nautical:new Yt(1715021),civil:new Yt(4942493),sunriseEdge:new Yt(16752762),daytime:new Yt(8900331)},r={night:{intensity:.01,color:new Yt(4420),heightThreshold:-Math.PI/6},nautical:{intensity:.1,color:new Yt(3362176),heightThreshold:-Math.PI/12},civil:{intensity:.3,color:new Yt(7833770),heightThreshold:-Math.PI/36},sunrise:{intensity:.6,color:new Yt(16768443),heightThreshold:0},day:{intensity:1,color:new Yt(16777215),heightThreshold:Math.PI/12}},o=an+Qh,a=Math.PI/6,l=5*Math.PI/4;let c=1,u=1,h,d,p,_,v,m,f,w,b,x=null;const T=()=>{const P=()=>{const it=document.createElement("canvas");it.width=512,it.height=512;const lt=it.getContext("2d");lt.fillStyle="#008000",lt.fillRect(0,0,it.width,it.height),lt.strokeStyle="#ffffff",lt.lineWidth=4,lt.beginPath(),lt.moveTo(it.width/2,0),lt.lineTo(it.width/2,it.height),lt.moveTo(0,it.height/2),lt.lineTo(it.width,it.height/2),lt.stroke();const ht=new lo(it),Nt=new uh({map:ht,side:ci}),W=document.createElement("canvas");W.width=512,W.height=512;const st=W.getContext("2d");st.fillStyle="#000000",st.fillRect(0,0,W.width,W.height),st.strokeStyle="#ffffff",st.lineWidth=4,st.beginPath(),st.moveTo(W.width/2,0),st.lineTo(W.width/2,W.height),st.moveTo(0,W.height/2),st.lineTo(W.width,W.height/2),st.stroke();const xt=new lo(W),mt=new uh({map:xt,side:Be}),ft=new Vc(an,64),zt=new ve(ft,Nt);zt.position.set(0,0,0),zt.rotation.set(-Math.PI/2,0,0),h.add(zt);const bt=new ve(ft,mt);bt.position.set(0,0,0),bt.rotation.set(-Math.PI/2,0,0),h.add(bt)},C=()=>{const it=new ri(an,64,64),lt=new nn({color:16777215,transparent:!0,opacity:.05,side:Be}),ht=new ve(it,lt);ht.position.set(0,0,0),ht.rotation.set(0,0,0),h.add(ht)},L=()=>{const it=new ri(_y,32,32),lt=new nn({color:16776960});v=new ve(it,lt),h.add(v)},A=()=>{const it=new Gc(an-Kh/2,an+Kh/2,64),lt=new nn({color:16776960,transparent:!0,opacity:.7,side:pn});m=new ve(it,lt),m.position.x=0,m.rotation.y=0,m.rotation.z=0},S=()=>{const it=new Gs(Jh,Jh,an,16),lt=new nn({color:65535,transparent:!0,opacity:.7,side:pn});f=new ve(it,lt),f.position.x=0,f.rotation.y=0,f.rotation.z=0},I=()=>{w=[],[3*Math.PI/2,0,Math.PI/2,Math.PI].forEach(lt=>{const ht=document.createElement("canvas"),Nt=new lo(ht),W=new Id({map:Nt}),st=new J_(W);st.position.set(o*Math.cos(lt),.01,o*Math.sin(lt)),st.scale.setScalar(Qh),w.push(st),h.add(st)})},F=it=>{e.value=it},O=it=>{i.value=it,i.value.isEarthSceneToggle?(c=.5,G()):(c=1,G())},Y=()=>{const it=e.value.solarData,lt=it.solarDeclination*Math.PI/180,ht=it.solarHeight*Math.PI/180,Nt=(it.solarDirection-90)*Math.PI/180,W=e.value.latitude*Math.PI/180;v.position.x=an*Math.cos(Nt)*Math.cos(ht),v.position.y=an*Math.sin(ht),v.position.z=an*Math.sin(Nt)*Math.cos(ht),i.value.isSunTrajectoryToggle?(h.children.includes(m)||h.add(m),m.position.y=an*Math.sin(lt)*Math.sin(W),m.position.z=-an*Math.sin(lt)*Math.cos(W),m.rotation.x=W,m.scale.setScalar(Math.cos(lt))):h.children.includes(m)&&h.remove(m),i.value.isPoleStarPointerToggle?(h.children.includes(f)||h.add(f),f.position.y=an/2*Math.sin(W),f.position.z=-an/2*Math.cos(W),f.rotation.x=W-Math.PI/2):h.children.includes(f)&&h.remove(f);const st=["北","东","南","西"];W==Math.PI/2?st.fill("南"):W==-Math.PI/2&&st.fill("北"),st.forEach((ft,zt)=>{const bt=document.createElement("canvas"),Jt=bt.getContext("2d");Jt.font=`${po}px Arial`;const R=Jt.measureText(ft).width;bt.width=R,bt.height=po,Jt.font=`${po}px Arial`,Jt.fillStyle="white",Jt.textBaseline="middle",Jt.fillText(ft,0,po/2);const D=new lo(bt),M=w[zt].material;M.map=D,M.needsUpdate=!0});let xt;if(ht<=r.night.heightThreshold)xt=r.night;else if(ht<=r.nautical.heightThreshold){const ft=(ht-r.night.heightThreshold)/(r.nautical.heightThreshold-r.night.heightThreshold);xt={intensity:rr.lerp(r.night.intensity,r.nautical.intensity,ft),color:r.night.color.clone().lerp(r.nautical.color,ft)}}else if(ht<=r.civil.heightThreshold){const ft=(ht-r.nautical.heightThreshold)/(r.civil.heightThreshold-r.nautical.heightThreshold);xt={intensity:rr.lerp(r.nautical.intensity,r.civil.intensity,ft),color:r.nautical.color.clone().lerp(r.civil.color,ft)}}else if(ht<=r.sunrise.heightThreshold){const ft=(ht-r.civil.heightThreshold)/(r.sunrise.heightThreshold-r.civil.heightThreshold);xt={intensity:rr.lerp(r.civil.intensity,r.sunrise.intensity,ft),color:r.civil.color.clone().lerp(r.sunrise.color,ft)}}else{const ft=Math.min(1,ht/r.day.heightThreshold);xt={intensity:rr.lerp(r.sunrise.intensity,r.day.intensity,ft),color:r.sunrise.color.clone().lerp(r.day.color,ft)}}b.intensity=xt.intensity,b.color.copy(xt.color);let mt;if(ht<=-Math.PI/6)mt=s.astronomical;else if(ht<=-Math.PI/12){const ft=(ht+Math.PI/6)/(Math.PI/12);mt=s.astronomical.clone().lerp(s.nautical,ft)}else if(ht<=-Math.PI/36){const ft=(ht+Math.PI/12)/(Math.PI/18);mt=s.nautical.clone().lerp(s.civil,ft)}else if(ht<=0){const ft=(ht+Math.PI/36)/(Math.PI/36);mt=s.civil.clone().lerp(s.sunriseEdge,ft)}else{const ft=Math.min(1,ht/(Math.PI/12));mt=s.sunriseEdge.clone().lerp(s.daytime,ft)}h.background=mt},tt=()=>{x=requestAnimationFrame(tt),_.update(),Y(),p.render(h,d)},G=()=>{d.aspect=window.innerWidth*c/(window.innerHeight*u),d.updateProjectionMatrix(),p.setSize(window.innerWidth*c,window.innerHeight*u)},Z=t.value;h=new zc,h.background=s.daytime,d=new en(xy,window.innerWidth*c/(window.innerHeight*u),My,Sy),d.position.x=sl*Math.cos(l)*Math.cos(a),d.position.y=sl*Math.sin(a),d.position.z=sl*Math.sin(l)*Math.cos(a),d.lookAt(0,0,0),p=new Yc({antialias:!0}),Z.appendChild(p.domElement),_=new jc(d,p.domElement),_.enableDamping=!0,_.dampingFactor=vy,_.enablePan=!1,_.enableZoom=!0,_.enableRotate=!0,b=new Wc(16777215,0),h.add(b);const V=Xs(F),ct=$c(O);P(),C(),L(),A(),S(),I(),tt(),G(),window.addEventListener("resize",G),li(()=>{V(),ct(),x&&cancelAnimationFrame(x),window.removeEventListener("resize",G),Z&&(p!=null&&p.domElement)&&Z.removeChild(p.domElement),p==null||p.dispose(),_==null||_.dispose()})};return Qi(()=>{T()}),(P,C)=>(Me(),Ue("div",{ref_key:"sceneContainer",ref:t},null,512))}},Yd="/solar-visual-motion-simulator/assets/img_earth_surface-HdJWrKIz.png",Ey="data:image/png;base64,",ys=3,tf=.02,ef=.5,Ay=.05,nf=.02,mo=100,Ty=.05,by=75,wy=.1,Ry=100,rl=7.5,Cy={__name:"EarthScene",setup(n){const t=kt(null),e=kt({longitude:0,latitude:0,solarData:{obliquityOfEcliptic:0,solarDeclination:0,solarRightAscension:0}}),i=kt({isGroundSceneToggle:!0,isEarthSceneToggle:!1,isGridToggle:!1,isPinToggle:!0,isSunRayPointerToggle:!1}),s=ys+.01,r=ys+.02;let o=1,a=1,l,c,u,h,d,p,_,v,m,f=null;const w=()=>{const b=()=>{const ct=new ri(ys,128,128),it=new rc().load(Yd,ht=>{ht.generateMipmaps=!1,ht.magFilter=Fe,ht.minFilter=Fe,ht.wrapS=ht.wrapT=Fn,d.material.needsUpdate=!0}),lt=new nn({map:it,alphaTest:.1});d=new ve(ct,lt),d.position.set(0,0,0),d.rotation.set(0,0,0),l.add(d)},x=()=>{const ct=new ri(s,128,128),it=new rc().load(Ey,ht=>{ht.generateMipmaps=!1,ht.magFilter=Fe,ht.minFilter=Fe,ht.wrapS=ht.wrapT=Fn,p.material.needsUpdate=!0}),lt=new nn({map:it,alphaTest:.1,transparent:!0});p=new ve(ct,lt),p.position.set(0,0,0),p.rotation.x=0,l.add(p)},T=()=>{const ct=new Gs(tf,tf,ef,16),it=new nn({color:16711680}),lt=new ve(ct,it),ht=new ri(Ay,32,32),Nt=new nn({color:16711680}),W=new ve(ht,Nt);W.position.y=ef/2,_=new Xi,_.add(lt),_.add(W),_.rotation.x=0},P=()=>{const ct=new Gs(nf,nf,mo,16),it=new nn({color:16776960,transparent:!0,opacity:.7,side:pn});m=new ve(ct,it),m.rotation.x=0},C=()=>{v=new Xi;const ct=new Hc({color:16777215,transparent:!0,opacity:.5}),it=new iv({color:16777215,dashSize:.1,gapSize:.05,transparent:!0,opacity:.7});for(let Nt=-180;Nt<=180;Nt+=30){const W=Nt*Math.PI/180,st=[];for(let ft=-90;ft<=90;ft+=5){const zt=ft*Math.PI/180,bt=r*Math.cos(zt)*Math.cos(W),Jt=r*Math.sin(zt),R=r*Math.cos(zt)*Math.sin(W);st.push(new H(bt,Jt,R))}const xt=new Ve().setFromPoints(st),mt=new Za(xt,ct);v.add(mt)}for(let Nt=-90;Nt<=90;Nt+=30){const W=Nt*Math.PI/180,st=[];for(let ft=-180;ft<=180;ft+=5){const zt=ft*Math.PI/180,bt=r*Math.cos(W)*Math.cos(zt),Jt=r*Math.sin(W),R=r*Math.cos(W)*Math.sin(zt);st.push(new H(bt,Jt,R))}const xt=new Ve().setFromPoints(st),mt=new Za(xt,ct);v.add(mt)}const lt=e.value.solarData.obliquityOfEcliptic;[lt,90-lt,-lt,lt-90].forEach(Nt=>{const W=[],st=Nt*Math.PI/180;for(let ft=-180;ft<=180;ft+=5){const zt=ft*Math.PI/180,bt=r*Math.cos(st)*Math.cos(zt),Jt=r*Math.sin(st),R=r*Math.cos(st)*Math.sin(zt);W.push(new H(bt,Jt,R))}const xt=new Ve().setFromPoints(W),mt=new Za(xt,it);mt.computeLineDistances(),v.add(mt)})},L=ct=>{e.value=ct},A=ct=>{i.value=ct,i.value.isGroundSceneToggle?(o=.5,F()):(o=1,F())},S=()=>{const ct=e.value.solarData,it=e.value.longitude*Math.PI/180,lt=e.value.latitude*Math.PI/180,ht=ct.solarDeclination*Math.PI/180,Nt=ct.solarRightAscension*Math.PI/180;p.rotation.y=Nt,p.rotation.z=ht,i.value.isSunRayPointerToggle?(l.children.includes(m)||l.add(m),m.position.x=mo/2*Math.cos(Nt)*Math.cos(ht),m.position.y=mo/2*Math.sin(ht),m.position.z=-mo/2*Math.sin(Nt)*Math.cos(ht),m.rotation.y=Nt,m.rotation.z=ht-Math.PI/2):l.children.includes(m)&&l.remove(m),i.value.isPinToggle?(l.children.includes(_)||l.add(_),_.position.x=ys*Math.cos(it)*Math.cos(lt),_.position.y=ys*Math.sin(lt),_.position.z=-ys*Math.sin(it)*Math.cos(lt),_.rotation.y=it,_.rotation.z=lt-Math.PI/2):l.children.includes(_)&&l.remove(_),i.value.isGridToggle?l.children.includes(v)||l.add(v):l.children.includes(v)&&l.remove(v)},I=()=>{f=requestAnimationFrame(I),h.update(),S(),u.render(l,c)},F=()=>{c.aspect=window.innerWidth*o/(window.innerHeight*a),c.updateProjectionMatrix(),u.setSize(window.innerWidth*o,window.innerHeight*a)},O=t.value;l=new zc,l.background=new Yt(0),c=new en(by,window.innerWidth*o/(window.innerHeight*a),wy,Ry),u=new Yc({antialias:!0,powerPreference:"high-performance"}),O.appendChild(u.domElement),h=new jc(c,u.domElement),h.enableDamping=!0,h.dampingFactor=Ty,h.enablePan=!1,h.enableZoom=!1,h.enableRotate=!0;const Y=new Wc(16777215,0);l.add(Y);const tt=Xs(L),G=$c(A),Z=e.value.latitude*Math.PI/180,V=e.value.longitude*Math.PI/180;c.position.x=rl*Math.cos(V)*Math.cos(Z),c.position.y=rl*Math.sin(Z),c.position.z=-rl*Math.sin(V)*Math.cos(Z),c.lookAt(0,0,0),b(),x(),P(),T(),C(),I(),F(),window.addEventListener("resize",F),li(()=>{tt(),G(),f&&cancelAnimationFrame(f),window.removeEventListener("resize",F),O&&(u!=null&&u.domElement)&&O.removeChild(u.domElement),u==null||u.dispose(),h==null||h.dispose()})};return Qi(()=>{w()}),(b,x)=>(Me(),Ue("div",{ref_key:"sceneContainer",ref:t},null,512))}},Kc={__name:"Draggable",setup(n,{expose:t}){const e=kt(!1),i=kt(!1),s=kt(0),r=kt(0),o=kt(0),a=kt(0),l=kt(0),c=kt(0),u=kt(""),h=kt(""),d=w=>{e.value=w},p=(w,b)=>{u.value=w,h.value=b,i.value=ne.get(h.value)??!1,l.value=ne.get(`${h.value}_left`)??0,c.value=ne.get(`${h.value}_top`)??0;const x=document.querySelector(`.${u.value}`);x&&(x.style.left=`${l.value}px`,x.style.top=`${c.value}px`)},_=()=>{i.value=!i.value,ne.set(h.value,i.value),i.value||f()},v=w=>{if(i.value){s.value=w.clientX,r.value=w.clientY;const b=document.querySelector(`.${u.value}`);o.value=parseFloat(getComputedStyle(b).left)||0,a.value=parseFloat(getComputedStyle(b).top)||0,document.addEventListener("mousemove",m),document.addEventListener("mouseup",f)}},m=w=>{const b=w.clientX-s.value,x=w.clientY-r.value,T=document.querySelector(`.${u.value}`);if(T){const P=T.offsetWidth,C=T.offsetHeight,L=window.innerWidth,A=window.innerHeight-60;l.value=o.value+b,c.value=a.value+x,l.value<0?l.value=0:l.value>L-P&&(l.value=L-P),c.value<0?c.value=0:c.value>A-C&&(c.value=A-C),T.style.left=`${l.value}px`,T.style.top=`${c.value}px`}},f=()=>{ne.set(`${h.value}_left`,l.value),ne.set(`${h.value}_top`,c.value),document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",f)};return zf(()=>{f()}),t({isButtonShow:e,isDraggable:i,setButtonShow:d,setClassName:p,toggleDraggable:_,startDrag:v}),(w,b)=>null}},Py={key:1},Dy={key:2},Iy={key:3},Ly={key:4},Uy={key:5},Ny={__name:"InformationDisplay",setup(n){const t=kt(null),e=kt(""),i=kt(""),s=kt(""),r=kt(""),o=kt(""),a=kt({solarDeclination:0,solarRightAscension:0,solarHourAngle:0,solarDirection:0,solarHeight:0,dayLength:{polarDay:!1,polarNight:!1,dayLength:12,sunRise:12,sunSet:12}}),l=kt(!1),c=u=>{const h=u.date,d=u.timeZone,p=Math.floor(Math.abs(d)),_=Math.abs(d)%1*60,v=p.toString().padStart(2,"0"),m=_.toString().padStart(2,"0");e.value=`${h.toLocaleString()} UTC${d<0?"-":"+"}${v}:${m}`,a.value=u.solarData,l.value=a.value.solarHeight<0;const f=a.value.solarDirection;if(f<22.5?o.value="N":f<67.5?o.value="NE":f<112.5?o.value="E":f<157.5?o.value="SE":f<202.5?o.value="S":f<247.5?o.value="SW":f<292.5?o.value="W":f<337.5?o.value="NW":o.value="N",!a.value.dayLength.polarDay&&!a.value.dayLength.polarNight){const w=a.value.dayLength.dayLength,b=Math.floor(w),x=Math.floor(w%1*60),T=Math.floor(w%(1/60)*3600),P=b.toString().padStart(2,"0"),C=x.toString().padStart(2,"0"),L=T.toString().padStart(2,"0");i.value=`${P}:${C}:${L}`;const A=a.value.dayLength.sunRise,S=Math.floor(A),I=Math.floor(A%1*60),F=Math.floor(A%(1/60)*3600),O=S.toString().padStart(2,"0"),Y=I.toString().padStart(2,"0"),tt=F.toString().padStart(2,"0");s.value=`${O}:${Y}:${tt}`;const G=a.value.dayLength.sunSet,Z=Math.floor(G),V=Math.floor(G%1*60),ct=Math.floor(G%(1/60)*3600),it=Z.toString().padStart(2,"0"),lt=V.toString().padStart(2,"0"),ht=ct.toString().padStart(2,"0");r.value=`${it}:${lt}:${ht}`}};return Qi(()=>{t.value.setClassName("information-display","information_display");const u=Xs(c);li(()=>{u()})}),(u,h)=>{var d,p,_,v,m,f;return Me(),Ue("div",null,[_n(Kc,{ref_key:"draggableRef",ref:t},null,512),Bt("div",{class:oe(["floating-box information-display",{"floating-box-day":!l.value,"floating-box-night":l.value,"floating-box-draggable":(d=t.value)==null?void 0:d.isDraggable}]),onMouseenter:h[1]||(h[1]=w=>{var b;return(b=t.value)==null?void 0:b.setButtonShow(!0)}),onMouseleave:h[2]||(h[2]=w=>{var b;return(b=t.value)==null?void 0:b.setButtonShow(!1)}),onMousedown:h[3]||(h[3]=w=>{var b;return(b=t.value)==null?void 0:b.startDrag(w)})},[(p=t.value)!=null&&p.isButtonShow?(Me(),Ue("button",{key:0,class:oe(["drag-button",{"drag-button-day-lock":!l.value&&((_=t.value)==null?void 0:_.isDraggable),"drag-button-night-lock":l.value&&((v=t.value)==null?void 0:v.isDraggable),"drag-button-day-unlock":!l.value&&!((m=t.value)!=null&&m.isDraggable),"drag-button-night-unlock":l.value&&!((f=t.value)!=null&&f.isDraggable)}]),onClick:h[0]||(h[0]=(...w)=>{var b,x;return((b=t.value)==null?void 0:b.toggleDraggable)&&((x=t.value)==null?void 0:x.toggleDraggable(...w))})},null,2)):qe("",!0),h[4]||(h[4]=Bt("br",null,null,-1)),h[5]||(h[5]=Bt("div",null,"信息显示:",-1)),Bt("div",null,"时间: "+En(e.value),1),Bt("div",null,"太阳赤经: "+En(a.value.solarRightAscension.toFixed(3))+"°",1),Bt("div",null,"太阳赤纬: "+En(a.value.solarDeclination.toFixed(3))+"°",1),Bt("div",null,"太阳时角: "+En(a.value.solarHourAngle.toFixed(3))+"°",1),Bt("div",null,"太阳方位角: "+En(a.value.solarDirection.toFixed(3))+"° ("+En(o.value)+")",1),Bt("div",null,"太阳高度角: "+En(a.value.solarHeight.toFixed(3))+"°",1),h[6]||(h[6]=Bt("br",null,null,-1)),!a.value.dayLength.polarDay&&!a.value.dayLength.polarNight?(Me(),Ue("div",Py,"昼长: "+En(i.value),1)):qe("",!0),!a.value.dayLength.polarDay&&!a.value.dayLength.polarNight?(Me(),Ue("div",Dy,"日出时间: "+En(s.value),1)):qe("",!0),!a.value.dayLength.polarDay&&!a.value.dayLength.polarNight?(Me(),Ue("div",Iy,"日落时间: "+En(r.value),1)):qe("",!0),a.value.dayLength.polarDay?(Me(),Ue("div",Ly,"极昼")):qe("",!0),a.value.dayLength.polarNight?(Me(),Ue("div",Uy,"极夜")):qe("",!0)],34)])}}},Jc=(n,t)=>{const e=n.__vccOpts||n;for(const[i,s]of t)e[i]=s;return e},go=1,sf=.01,rf=.3,Fy=.02,ol=300,Oy=.05,By=75,zy=.1,Hy=100,ir=2,Vy={__name:"Location",setup(n){const t=kt(null),e=kt(null),i=kt(0),s=kt(0),r=kt(!1),o=kt(null),a=kt(null),l=ol;let c,u,h,d,p,_,v=!1,m=null;const f=()=>{const x=()=>{const Y=new ri(go,128,128),tt=new rc().load(Yd,Z=>{Z.generateMipmaps=!1,Z.magFilter=Fe,Z.minFilter=Fe,Z.wrapS=Z.wrapT=Fn,p.material.needsUpdate=!0}),G=new nn({map:tt,alphaTest:.1});p=new ve(Y,G),p.position.set(0,0,0),p.rotation.set(0,0,0),c.add(p)},T=()=>{const Y=new Gs(sf,sf,rf,16),tt=new nn({color:16711680}),G=new ve(Y,tt),Z=new ri(Fy,32,32),V=new nn({color:16711680}),ct=new ve(Z,V);ct.position.y=rf/2,_=new Xi,_.add(G),_.add(ct),_.rotation.x=0,c.add(_)},P=()=>{var G;const Y=i.value*Math.PI/180,tt=s.value*Math.PI/180;d.enabled=!((G=t.value)!=null&&G.isDraggable),v||(u.position.x=ir*Math.cos(Y)*Math.cos(tt),u.position.y=ir*Math.sin(tt),u.position.z=-ir*Math.sin(Y)*Math.cos(tt),u.lookAt(0,0,0)),_.position.x=go*Math.cos(Y)*Math.cos(tt),_.position.y=go*Math.sin(tt),_.position.z=-go*Math.sin(Y)*Math.cos(tt),_.rotation.y=Y,_.rotation.z=tt-Math.PI/2},C=()=>{m=requestAnimationFrame(C),d.update(),P(),h.render(c,u)},L=()=>{v=!0},A=()=>{v=!1},S=()=>{v&&(i.value=parseFloat(Math.atan2(-u.position.z,u.position.x)*180/Math.PI).toFixed(1),s.value=parseFloat(Math.asin(u.position.y/ir)*180/Math.PI).toFixed(1),w())},I=()=>{u.aspect=ol/l,u.updateProjectionMatrix(),h.setSize(ol,l),h.setPixelRatio(Math.min(2,window.devicePixelRatio))},F=e.value;c=new zc,u=new en(By,window.innerWidth/window.innerHeight,zy,Hy),u.position.set(ir,0,0),u.lookAt(0,0,0),h=new Yc({antialias:!0,powerPreference:"high-performance",alpha:!0}),h.setPixelRatio(window.devicePixelRatio||1),F.appendChild(h.domElement),h.domElement.addEventListener("mousedown",L),h.domElement.addEventListener("mouseup",A),d=new jc(u,h.domElement),d.enableDamping=!0,d.dampingFactor=Oy,d.enablePan=!1,d.enableZoom=!1,d.enableRotate=!0,d.addEventListener("change",S);const O=new Wc(16777215,0);c.add(O),x(),T(),C(),I(),window.addEventListener("resize",I),li(()=>{m&&cancelAnimationFrame(m),d.removeEventListener("change",S),window.removeEventListener("resize",I),F&&(h!=null&&h.domElement)&&(h.domElement.removeEventListener("mousedown",L),h.domElement.removeEventListener("mouseup",A),F.removeChild(h.domElement)),h==null||h.dispose(),d==null||d.dispose()})},w=()=>{my(i.value,s.value)},b=x=>{const T=document.activeElement,P=o.value===T,C=a.value===T;P||(i.value=x.longitude),C||(s.value=x.latitude),r.value=x.solarData.solarHeight<0};return Qi(()=>{t.value.setClassName("location-control","location_control"),f();const x=Xs(b);li(()=>{x()})}),(x,T)=>{var P,C,L,A,S,I;return Me(),Ue("div",null,[_n(Kc,{ref_key:"draggableRef",ref:t},null,512),Bt("div",{class:oe(["floating-box location-control",{"floating-box-day":!r.value,"floating-box-night":r.value,"floating-box-draggable":(P=t.value)==null?void 0:P.isDraggable}]),onMouseenter:T[3]||(T[3]=F=>{var O;return(O=t.value)==null?void 0:O.setButtonShow(!0)}),onMouseleave:T[4]||(T[4]=F=>{var O;return(O=t.value)==null?void 0:O.setButtonShow(!1)}),onMousedown:T[5]||(T[5]=F=>{var O;return(O=t.value)==null?void 0:O.startDrag(F)})},[(C=t.value)!=null&&C.isButtonShow?(Me(),Ue("button",{key:0,class:oe(["drag-button",{"drag-button-day-lock":!r.value&&((L=t.value)==null?void 0:L.isDraggable),"drag-button-night-lock":r.value&&((A=t.value)==null?void 0:A.isDraggable),"drag-button-day-unlock":!r.value&&!((S=t.value)!=null&&S.isDraggable),"drag-button-night-unlock":r.value&&!((I=t.value)!=null&&I.isDraggable)}]),onClick:T[0]||(T[0]=(...F)=>{var O,Y;return((O=t.value)==null?void 0:O.toggleDraggable)&&((Y=t.value)==null?void 0:Y.toggleDraggable(...F))})},null,2)):qe("",!0),T[10]||(T[10]=Bt("br",null,null,-1)),T[11]||(T[11]=Bt("div",null,"位置设置:",-1)),Bt("div",null,[T[6]||(T[6]=Ye(" 经度: ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[1]||(T[1]=F=>i.value=F),ref_key:"longitudeInput",ref:o,onInput:w,min:"-180",max:"180",step:"0.1",class:oe({"input-day":!r.value,"input-night":r.value})},null,34),[[Ln,i.value,void 0,{number:!0}]]),T[7]||(T[7]=Ye(" ° "))]),Bt("div",null,[T[8]||(T[8]=Ye(" 纬度: ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[2]||(T[2]=F=>s.value=F),ref_key:"latitudeInput",ref:a,onInput:w,min:"-90",max:"90",step:"0.1",class:oe({"input-day":!r.value,"input-night":r.value})},null,34),[[Ln,s.value,void 0,{number:!0}]]),T[9]||(T[9]=Ye(" ° "))]),Bt("div",{class:"earth-preview",ref_key:"earthContainer",ref:e},null,512)],34)])}}},Gy=Jc(Vy,[["__scopeId","data-v-830818ae"]]),ky=["max"],Wy={__name:"Time",setup(n){const t=kt(null),e=kt({year:1970,month:1,date:1,hour:0,minute:0,second:0,daysOfMonth:0}),i=kt(0),s=kt(!0),r=kt(0),o=kt(!1),a=kt(null),l=kt(null),c=kt(null),u=kt(null),h=kt(null),d=kt(null),p=kt(null),_=kt(null),v=()=>{gy(new Date(e.value.year,e.value.month-1,e.value.date,e.value.hour,e.value.minute,e.value.second))},m=()=>{dy(i.value)},f=()=>{py(r.value)},w=()=>{Gd(s.value)},b=x=>{const T=document.activeElement,P=a.value===T,C=l.value===T,L=c.value===T,A=u.value===T,S=h.value===T,I=d.value===T,F=p.value===T,O=_.value===T,Y=x.date;P||(e.value.year=Y.getFullYear()),C||(e.value.month=Y.getMonth()+1),L||(e.value.date=Y.getDate()),A||(e.value.hour=Y.getHours()),S||(e.value.minute=Y.getMinutes()),I||(e.value.second=Y.getSeconds()),F||(i.value=x.timeZone),O||(r.value=x.timeLapse),s.value=x.timeSync,o.value=x.solarData.solarHeight<0;let tt=[0,31,28,31,30,31,30,31,31,30,31,30,31];const G=Y.getFullYear();(G%400==0||G%4==0&&G%100!=0)&&(tt[2]=29),e.value.daysOfMonth=tt[e.value.month]};return Qi(()=>{t.value.setClassName("time-control","time_control");const x=Xs(b);li(()=>{x()})}),(x,T)=>{var P,C,L,A,S,I;return Me(),Ue("div",null,[_n(Kc,{ref_key:"draggableRef",ref:t},null,512),Bt("div",{class:oe(["floating-box time-control",{"floating-box-day":!o.value,"floating-box-night":o.value,"floating-box-draggable":(P=t.value)==null?void 0:P.isDraggable}]),onMouseenter:T[10]||(T[10]=F=>{var O;return(O=t.value)==null?void 0:O.setButtonShow(!0)}),onMouseleave:T[11]||(T[11]=F=>{var O;return(O=t.value)==null?void 0:O.setButtonShow(!1)}),onMousedown:T[12]||(T[12]=F=>{var O;return(O=t.value)==null?void 0:O.startDrag(F)})},[(C=t.value)!=null&&C.isButtonShow?(Me(),Ue("button",{key:0,class:oe(["drag-button",{"drag-button-day-lock":!o.value&&((L=t.value)==null?void 0:L.isDraggable),"drag-button-night-lock":o.value&&((A=t.value)==null?void 0:A.isDraggable),"drag-button-day-unlock":!o.value&&!((S=t.value)!=null&&S.isDraggable),"drag-button-night-unlock":o.value&&!((I=t.value)!=null&&I.isDraggable)}]),onClick:T[0]||(T[0]=(...F)=>{var O,Y;return((O=t.value)==null?void 0:O.toggleDraggable)&&((Y=t.value)==null?void 0:Y.toggleDraggable(...F))})},null,2)):qe("",!0),T[23]||(T[23]=Bt("br",null,null,-1)),T[24]||(T[24]=Bt("div",null,"时间设置:",-1)),Bt("div",null,[T[13]||(T[13]=Ye(" 日期: ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[1]||(T[1]=F=>e.value.year=F),ref_key:"yearInput",ref:a,onInput:v,min:"1970",max:"9999",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,e.value.year,void 0,{number:!0}]]),T[14]||(T[14]=Ye(" / ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[2]||(T[2]=F=>e.value.month=F),ref_key:"monthInput",ref:l,onInput:v,min:"1",max:"12",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,e.value.month,void 0,{number:!0}]]),T[15]||(T[15]=Ye(" / ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[3]||(T[3]=F=>e.value.date=F),ref_key:"dateInput",ref:c,onInput:v,min:"1",max:e.value.daysOfMonth,step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,42,ky),[[Ln,e.value.date,void 0,{number:!0}]])]),Bt("div",null,[T[16]||(T[16]=Ye(" 时刻: ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[4]||(T[4]=F=>e.value.hour=F),ref_key:"hourInput",ref:u,onInput:v,min:"0",max:"23",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,e.value.hour,void 0,{number:!0}]]),T[17]||(T[17]=Ye(" : ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[5]||(T[5]=F=>e.value.minute=F),ref_key:"minuteInput",ref:h,onInput:v,min:"0",max:"59",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,e.value.minute,void 0,{number:!0}]]),T[18]||(T[18]=Ye(" : ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[6]||(T[6]=F=>e.value.second=F),ref_key:"secondInput",ref:d,onInput:v,min:"0",max:"59",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,e.value.second,void 0,{number:!0}]])]),Bt("div",null,[T[19]||(T[19]=Ye(" 使用时区(UTC): ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[7]||(T[7]=F=>i.value=F),ref_key:"timeZoneInput",ref:p,onInput:m,min:"-12",max:"12",step:"0.5",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,i.value,void 0,{number:!0}]])]),Bt("div",null,[T[20]||(T[20]=Ye(" 时间流逝倍率: ")),An(Bt("input",{type:"number","onUpdate:modelValue":T[8]||(T[8]=F=>r.value=F),ref_key:"timeLapseInput",ref:_,onInput:f,min:"-9",max:"9",step:"1",class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[Ln,r.value,void 0,{number:!0}]]),T[21]||(T[21]=Ye(" 倍 "))]),Bt("div",null,[T[22]||(T[22]=Ye(" 同步现实时间: ")),An(Bt("input",{type:"checkbox","onUpdate:modelValue":T[9]||(T[9]=F=>s.value=F),onChange:w,class:oe({"input-day":!o.value,"input-night":o.value})},null,34),[[dg,s.value]])])],34)])}}},Xy=Jc(Wy,[["__scopeId","data-v-35d0c58c"]]),Yy={class:"scenes"},qy={class:"nav-bar"},jy={key:0},Zy={key:1},$y={__name:"App",setup(n){const t=kt({isGroundSceneToggle:!0,isEarthSceneToggle:!1,isInformationDisplayToggle:!1,isLocationControlToggle:!1,isTimeControlToggle:!1,isSunTrajectoryToggle:!0,isPoleStarPointerToggle:!0,isGridToggle:!1,isPinToggle:!0,isSunRayPointerToggle:!1}),e=kt(!1),i=r=>{e.value=r.solarData.solarHeight<0},s=r=>{t.value=r};return Qi(()=>{const r=Xs(i),o=$c(s);li(()=>{r(),o()})}),(r,o)=>(Me(),Ue("main",null,[Bt("div",Yy,[t.value.isGroundSceneToggle?(Me(),As(yy,{key:0})):qe("",!0),t.value.isEarthSceneToggle?(Me(),As(Cy,{key:1})):qe("",!0)]),t.value.isInformationDisplayToggle?(Me(),As(Ny,{key:0})):qe("",!0),t.value.isLocationControlToggle?(Me(),As(Gy,{key:1})):qe("",!0),t.value.isTimeControlToggle?(Me(),As(Xy,{key:2})):qe("",!0),Bt("div",qy,[Bt("button",{class:oe(["nav-bar-button toggle-information-display",{"nav-bar-button-day":t.value.isInformationDisplayToggle&&!e.value,"nav-bar-button-night":t.value.isInformationDisplayToggle&&e.value}]),onClick:o[0]||(o[0]=(...a)=>ye(kh)&&ye(kh)(...a))},null,2),Bt("button",{class:oe(["nav-bar-button toggle-location-control",{"nav-bar-button-day":t.value.isLocationControlToggle&&!e.value,"nav-bar-button-night":t.value.isLocationControlToggle&&e.value}]),onClick:o[1]||(o[1]=(...a)=>ye(Wh)&&ye(Wh)(...a))},null,2),Bt("button",{class:oe(["nav-bar-button toggle-time-control",{"nav-bar-button-day":t.value.isTimeControlToggle&&!e.value,"nav-bar-button-night":t.value.isTimeControlToggle&&e.value}]),onClick:o[2]||(o[2]=(...a)=>ye(Xh)&&ye(Xh)(...a))},null,2),o[10]||(o[10]=Bt("div",{class:"nav-bar-empty"},null,-1)),Bt("button",{class:oe(["nav-bar-button toggle-ground-scene",{"nav-bar-button-day":t.value.isGroundSceneToggle&&!e.value,"nav-bar-button-night":t.value.isGroundSceneToggle&&e.value}]),onClick:o[3]||(o[3]=(...a)=>ye(Vh)&&ye(Vh)(...a))},null,2),t.value.isGroundSceneToggle?(Me(),Ue("div",jy,[Bt("button",{class:oe(["nav-bar-button toggle-sun-trajectory",{"nav-bar-button-day":t.value.isSunTrajectoryToggle&&!e.value,"nav-bar-button-night":t.value.isSunTrajectoryToggle&&e.value}]),onClick:o[4]||(o[4]=(...a)=>ye(Yh)&&ye(Yh)(...a))},null,2),Bt("button",{class:oe(["nav-bar-button toggle-pole-star-pointer",{"nav-bar-button-day":t.value.isPoleStarPointerToggle&&!e.value,"nav-bar-button-night":t.value.isPoleStarPointerToggle&&e.value}]),onClick:o[5]||(o[5]=(...a)=>ye(qh)&&ye(qh)(...a))},null,2)])):qe("",!0),o[11]||(o[11]=Bt("div",{class:"nav-bar-empty"},null,-1)),Bt("button",{class:oe(["nav-bar-button toggle-earth-scene",{"nav-bar-button-day":t.value.isEarthSceneToggle&&!e.value,"nav-bar-button-night":t.value.isEarthSceneToggle&&e.value}]),onClick:o[6]||(o[6]=(...a)=>ye(Gh)&&ye(Gh)(...a))},null,2),t.value.isEarthSceneToggle?(Me(),Ue("div",Zy,[Bt("button",{class:oe(["nav-bar-button toggle-pin",{"nav-bar-button-day":t.value.isPinToggle&&!e.value,"nav-bar-button-night":t.value.isPinToggle&&e.value}]),onClick:o[7]||(o[7]=(...a)=>ye(Zh)&&ye(Zh)(...a))},null,2),Bt("button",{class:oe(["nav-bar-button toggle-grid",{"nav-bar-button-day":t.value.isGridToggle&&!e.value,"nav-bar-button-night":t.value.isGridToggle&&e.value}]),onClick:o[8]||(o[8]=(...a)=>ye(jh)&&ye(jh)(...a))},null,2),Bt("button",{class:oe(["nav-bar-button toggle-sun-ray-pointer",{"nav-bar-button-day":t.value.isSunRayPointerToggle&&!e.value,"nav-bar-button-night":t.value.isSunRayPointerToggle&&e.value}]),onClick:o[9]||(o[9]=(...a)=>ye($h)&&ye($h)(...a))},null,2)])):qe("",!0)])]))}},Ky=Jc($y,[["__scopeId","data-v-1c8ce930"]]),Jy=_g(Ky);Jy.mount("#app");
